...
((("validation", seealso="functional testing (FT)")))((("validation", "blank items", id="ix_validationblank", range="startofrange")))((("functional test (FT)", "blank items", id="ix_FTblank", range="startofrange")))((("blank items, preventing", id="ix_blankitems", range="startofrange")))As our first few users start using the site, we've noticed they sometimes make 
...
((("functional test (FT)", "splitting")))We start putting each test into its own class, still in the same file:
...
((("functional test (FT)", "for layout and style")))((("layout and style", "functional tests (FT) for")))The layout and styling FT should now be one file and one class:
