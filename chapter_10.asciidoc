...
((("helper methods")))'base.py' can be cut down to just the `FunctionalTest` class.  We leave the
...
((("helper methods")))The technique of keeping helper methods in a parent class is meant to prevent
