...
<3> Django uses `SECRET_KEY` for some of its crypto--cookies and CSRF
    ...
    https://docs.djangoproject.com/en/1.10/topics/signing/[Django docs].
...
[superlists.ottg.eu] out: Downloading/unpacking Django==1.10.5 (from -r /home/el
[superlists.ottg.eu] out:   Downloading Django-1.10.5.tar.gz (8.0MB): 
[...]
[superlists.ottg.eu] out:   Downloading Django-1.10.5.tar.gz (8.0MB): 100%  8.0M
