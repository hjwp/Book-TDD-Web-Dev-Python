...
add the dunderinit--it needs to be there or else the tests folder isn't a valid Python module...footnote:["Dunder" is shorthand for double-underscore, so "dunderinit" means
'__init__.py'.]
...
another look at the diagram from the end of <<>> if you need to get your
bearings.
...
* 'remove hard-coded URL from forms in list.html and home.html'
...
*****
* 'remove hard-coded URLs from views.py'
* '[strikethrough line-through]#remove hard-coded URL from forms in list.html and home.html#'
* 'remove duplication of validation logic in views.'
*****
