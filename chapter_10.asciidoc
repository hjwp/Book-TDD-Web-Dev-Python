...
Another thing I want to do before we go further is to rewrite the main model
test.  I wrote it in a very verbose style, to introduce the Django ORM, but
in fact we can get the same coverage from a couple of much shorter tests:
