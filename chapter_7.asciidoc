...
Traceback (most recent call last):
  File "/workspace/superlists/functional_tests/tests.py", line 101, in
...
----
  File "/workspace/superlists/functional_tests/tests.py", line 112, in
test_layout_and_styling
    delta=3
AssertionError: 125.0 != 720.0 within 3 delta
----
...
----
$ *mkdir lists/static*
$ *wget https://github.com/twbs/bootstrap/archive/v2.3.2.zip*
