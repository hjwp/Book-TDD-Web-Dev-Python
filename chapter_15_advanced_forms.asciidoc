...
[role="sourcecode"]
.src/lists/tests/test_models.py (ch13l010)
====
[source,python]
----
...
[role="sourcecode"]
.src/lists/tests/test_models.py (ch13l011)
====
[source,python]
----
...
[role="sourcecode"]
.src/lists/tests/test_views.py (ch13l014)
====
[source,python]
----
...
[role="sourcecode"]
.src/lists/tests/test_views.py (ch13l015)
====
[source,python]
----
...
[role="sourcecode"]
.src/lists/tests/test_forms.py (ch13l016)
====
[source,python]
----
...
[role="sourcecode"]
.src/lists/tests/test_views.py (ch13l050)
====
[source,python]
----
class ListViewTest(TestCase):
...
[role="sourcecode"]
.src/lists/tests/test_forms.py (ch13l053)
====
[source,python]
----
