...
tutorial or get an introductory book like Dive Into Python <<dip>> or Learn
Python The Hard Way <<lpthw>>.

Obviously you will need access to a Python interpreter - on your own PC or via
a cloud service like PythonAnywhere. I'm also assuming you have a vague grasp
of how the web works - what HTML is, what a POST request is.  If you're not
sure about those, find a basic HTML tutorial. Figure out  how to create an
HTML page on your PC and look at it in your browser...
