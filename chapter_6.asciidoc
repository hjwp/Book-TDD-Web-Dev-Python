...
TODO: TemplateDoesNotExist stuff doesn't appear in Django 1.5. rewrite/upgrade.
...
TODO: from this point on, there is a difference between Django 1.4 and 1.5.
Need to rewrite for 1.5...
