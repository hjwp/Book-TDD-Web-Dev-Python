...
*******************************************************************************
🚧 Warning, this chapter is half-updated to Django 5.
Apologies for any incongruencies, thanks for bearing with me! 
*******************************************************************************
...
[role="sourcecode"]
.src/functional_tests/test_sharing.py (ch24l001)
====
[source,python]
----
...
[role="sourcecode"]
.src/functional_tests/test_sharing.py (ch24l004)
====
[source,python]
----
...
[role="sourcecode"]
.src/functional_tests/test_sharing.py (ch24l008)
====
[source,python]
----
        # She notices a "Share this list" option
...
[role="sourcecode"]
.src/functional_tests/list_page.py (ch24l009)
====
[source,python]
----
...
[role="sourcecode"]
.src/functional_tests/test_sharing.py (ch24l010)
====
[source,python]
----
...
[role="sourcecode"]
.src/functional_tests/my_lists_page.py (ch24l011)
====
[source,python]
----
from selenium.webdriver.common.by import By
...
[role="sourcecode"]
.src/functional_tests/test_sharing.py (ch24l012)
====
[source,python]
----
...
[role="sourcecode"]
.src/functional_tests/list_page.py (ch24l013)
====
[source,python]
----
class ListPage:
...
completed the "Exercise for the reader" in <<chapter_24_page_pattern>>.
______________________________________________________________
