...
((("functional test (FT)", "unittest model", id="ix_ch02-asciidoc0", range="startofrange")))((("unittest model",id="ix_ch02-asciidoc1", range="startofrange"" Let's adapt our test, which currently checks for the default Django 
