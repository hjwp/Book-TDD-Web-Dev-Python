...
<a data-type="indexterm" data-primary="test methods"></a></p></dd>
...
itself.<span data-type="footnote">The only exception is if you have an exception inside <code>setUp</code>, then <code>tearDown</code> doesn&#8217;t run.</span> No more Firefox windows left lying around!</p></dd>
...
<a data-type="indexterm" data-primary="warnings"></a></p></dd>
</dl>
++++
