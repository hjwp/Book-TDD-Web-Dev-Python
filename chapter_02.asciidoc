...
at how the whole application functions, from the outside.  Another term is a
...
other books.
//TODO: update if I do write an appendix about BDD
*******************************************************************************
...
<3> `setUp` and `tearDown` special methods which get
...
the book (eg in <<Personal-clientside-chapter>> and <<CI-chapter>>), you'll
