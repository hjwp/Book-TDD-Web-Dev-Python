...
((("Page Object pattern", "FT with multiple user")))Let's get started--we'll need two users for this FT:
...
((("Page Object pattern", "reducing duplication with", id="POPduplic25")))((("duplication, eliminating", id="dup25")))Before we go any further, I want to show an alternative method for reducing
...
The Page pattern::
    ((("Page Object pattern")))Moving helper methods into a base `FunctionalTest` class can become 
