...
((("functional tests (FTs)", "with multiple users", secondary-sortas="multiple users", id="FTmultiple25")))Are jokes about how "everything has to be social now" slightly old hat?
...
An exercise for the reader::
    ...
    next project.  I hope you'll enjoy it!((("", startref="FTmultiple25")))
