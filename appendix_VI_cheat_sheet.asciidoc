...
* Pick a test framework&8212;++unittest++ is fine, options like `py.test`,
...
Relevant chapters: <<chapter-4>>, <<manual-validation-chapter>>,
<<simple-form-chapter>>
...
painful, remember %%"listen to your tests"%%&8212;ugly, mocky tests may be
