...
Relevant chapters: <<manual-validation-chapter>>, <<simple-form-chapter>>
...
Relevant chapters: <<testfixtures-and-logging>>, <<CI-chapter>>, <<page-pattern-chapter>>
...
Relevant chapters: <<outside-in-chapter>>, <<isolation-chapter>>, <<hot-lava-chapter>>
