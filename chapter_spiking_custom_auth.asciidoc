...
NOTE: ((("questions and comments")))((("comments and questions")))((("contact information")))This chapter has been substantially rewritten for the new edition, so
...
((("exploratory coding", see="also spiking and despiking")))((("authentication", "spiking", id="Aspike18")))((("spiking and despiking", "defined")))((("prototyping", see="spiking and despiking")))Before I wrote this chapter all I knew about passwordless auth was the outline
...
((("spiking and despiking", "branching your VCS")))((("Git", "creating branches")))Before embarking on a spike, it's a good idea to start a new branch, so you
...
((("spiking and despiking", "frontend log in UI")))Let's start with the frontend, hack in an actual form to be able to
...
((("spiking and despiking", "sending emails from Django", id="SDemail18")))((("Django framework", "sending emails", id="DFemail18")))((("send_mail function", id="sendmail18")))((("emails, sending from Django", id="emails18")))The login theory will be something like this:
...
((("spiking and despiking", "avoding secrets in source code")))((("environment variables")))Sooner or later every project needs to figure out a way to deal with 
...
((("spiking and despiking", "storing tokens in databases")))((("tokens")))How are we doing?
...
((("spiking and despiking", "custom authentication models")))While we're messing about with models, let's start experimenting with
...
((("spiking and despiking", "custom Django authentication", id="SDcustom18")))Almost there—our last step combines recognising the token,
...
overcome a bug, which thankfully turned out to be irrelevant.((("", startref="SDcustom18")))((("", startref="Aspike18")))
...
((("stderr")))((("logging")))((("spiking and despiking", "logging to stderr")))While spiking, it's pretty critical to be able to see exceptions that are being
...
((("authentication", "despiking", id="Adespike18")))((("spiking and de-spiking", "de-spiking", id="SDde18")))De-spiking means rewriting your prototype code using TDD.  We now have enough
...
if it turns out neater than it did in the spike.((("", startref="Adespike18")))((("", startref="SDde18")))
...
((("spiking and de-spiking", "minimal custom user model", id="SDminimal18")))Django's built-in user model makes all sorts of assumptions about what
...
((("spiking and de-spiking", "token model to link emails", id="SDtoken18")))Next let's build a token model.  Here's a short unit test
