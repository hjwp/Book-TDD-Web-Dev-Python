...
((("authentication", "frontend log in UI")))Let's start with the frontend, hack in an actual form to be able to
...
((("authentication", "custom Django authentication", id="SDcustom18")))Almost there—our last step combines recognising the token,
