...
User Authentication, Spiking, and pass:[<span class=
"keep-together">De-Spiking</span>]
--------------------------------------------
...
By now I'm sure you can manage to create the tests folder and its `__init__.py`,
...
and also an auto-generated "ID" field as its primary key.  We could make it
even simpler!
