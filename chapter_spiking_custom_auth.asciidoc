...
learning curve. It's covered a little more in <<chapter_fixtures_and_debugging_staging>>, 
...
NOTE: I recommend reintroducing the `LOGGING` setting from earlier at this 
    ...
    we'll find out in <<chapter_fixtures_and_debugging_staging>>, it'll be useful for
    debugging later.
