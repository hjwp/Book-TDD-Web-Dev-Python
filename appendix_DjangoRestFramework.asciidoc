...
((("Django-Rest-Framework (DRF)", id="DRF33")))Having "rolled our own" REST API in the last appendix, it's time to take
...
((("Django-Rest-Framework (DRF)", "installation")))A quick `pip install` gets us DRF.  I'm just using the latest version, which
...
((("Django-Rest-Framework (DRF)", "tutorials")))((("Django-Rest-Framework (DRF)", "ModelSerializers")))The http://www.django-rest-framework.org/#tutorial[Django-Rest-Framework tutorial]
...
((("Django-Rest-Framework (DRF)", "ModelViewsets")))A ModelViewSet is DRF's way of defining all the different ways you can interact
...
((("Django-Rest-Framework (DRF)", "POST requests")))This is the point at which I gave up on fighting the framework and just saw
...
((("Django-Rest-Framework (DRF)", "client-side adaptations")))Our API no longer returns a flat array of the items in a list.  It returns an
...
((("Django-Rest-Framework (DRF)", "benefits of")))You may be wondering what the point of using this framework was.
