...
((("functional tests (FTs)", "using unittest module", id="FTunittest02")))((("unnittest module", "basic functional test creation", id="UTMbasic02")))Let's adapt our test, which currently checks for the default Django 
...
left a Firefox window hanging around the desktop, so it would be nice if this would
