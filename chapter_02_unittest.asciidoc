...
so they really let us see how the application _functions_ from the user's point of view.((("functiona tests (FTs)", "using unittest module", "Minimum Viable App, checking out")))
