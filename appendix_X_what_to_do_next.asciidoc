...
((("Test-Driven Development (TDD)", "future investigations", id="TDDfuture35")))Here I offer a few suggestions for things to investigate next, to develop your 
...
((("getting help")))I'm very happy to answer questions and provide tips and guidance on all
...
* Tip: one way of simulating Persona being down is to hack your hosts file (at '/etc/hosts' or 'c:\Windows\System32\drivers\etc'). Remember to revert it in
the test `tearDown`!
