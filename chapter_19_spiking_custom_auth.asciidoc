...
class UserModelTest(TestCase):
    def test_user_is_valid_with_email_only(self):  # <2>
...
// TODO: separate out a separate test for User == get_user_model()?
// talk about how this checks the model is compatible with django's auth system
