...
((("emails", "token model linking with unique ID", id="ix_emltkn")))((("authentication", "token model to link emails", id="SDtoken18")))
...
In the next chapter, we'll get into mocking—a key technique for testing external dependencies like email.((("emails", "token model linking with unique ID", startref="ix_emltkn")))((("", startref="SDtoken18")))
