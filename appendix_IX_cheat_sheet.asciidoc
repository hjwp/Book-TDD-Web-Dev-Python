...
Relevant chapters: <<chapter_philosophy_and_refactoring>>, <<chapter_post_and_database>>, <<chapter-6>>
...
Relevant chapters: <<chapter_philosophy_and_refactoring>>, <<manual-validation-chapter>>,
<<simple-form-chapter>>
