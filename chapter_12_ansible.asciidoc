...
but then we get ansible infra/deploy-playbook.yaml.yaml.
...
[role="sourcecode"]
.infra/deploy-playbook.yaml.yaml (ch11l001)
====
[source,yaml]
----
---
...
task path: ...goat-book/superlists/infra/deploy-playbook.yaml.yaml:2
ok: [staging.ottg.co.uk]
PLAYBOOK: deploy-playbook.yaml.yaml **********************************************
1 plays in infra/deploy-playbook.yaml.yaml

TASK [Install docker] *********************************************************
task path: ...goat-book/superlists/infra/deploy-playbook.yaml.yaml:6
...
task path: ...goat-book/superlists/infra/deploy-playbook.yaml.yaml:13
...
[role="sourcecode"]
.infra/deploy-playbook.yaml.yaml (ch11l002)
====
[source,yaml]
----
---
...
// task path: /path/to/goat-book/infra/deploy-playbook.yaml.yaml:12
...
TASK [Install docker] *********************************************************
task path: ...goat-book/superlists/infra/deploy-playbook.yaml.yaml:5
ok: [staging.ottg.co.uk] => {"cache_update_time": 1708982855, "cache_updated": false, "changed": false}

TASK [Export container image locally] *****************************************
task path: ...goat-book/superlists/infra/deploy-playbook.yaml.yaml:11
...
task path: ...goat-book/superlists/infra/deploy-playbook.yaml.yaml:18
...
task path: ...goat-book/superlists/infra/deploy-playbook.yaml.yaml:23
...
TASK [Run container] **********************************************************
task path: ...goat-book/superlists/infra/deploy-playbook.yaml.yaml:32
changed: [staging.ottg.co.uk] => {"changed": true, "container":
...
[role="sourcecode"]
.infra/deploy-playbook.yaml.yaml (ch11l003)
====
[source,yaml]
----
    - name: Install docker
...
.infra/deploy-playbook.yaml.yaml (ch11l005)
====
[source,yaml]
----
...
[subs="specialcharacters,macros"]
----
$ pass:quotes[*ansible-playbook --user=elspeth -i staging.ottg.co.uk, infra/deploy-playbook.yaml.yaml -v*]
[...]
PLAYBOOK: deploy-playbook.yaml.yaml **********************************************
1 plays in infra/deploy-playbook.yaml.yaml
...
[role="sourcecode"]
.infra/deploy-playbook.yaml.yaml (ch11l006)
====
[source,yaml]
----
    - name: Run container
...
[role="sourcecode"]
.infra/deploy-playbook.yaml.yaml (ch11l007)
====
[source,python]
----
