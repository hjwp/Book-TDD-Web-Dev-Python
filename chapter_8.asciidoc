...
*mkdir ~/sites/$SITENAME/database*
*mkdir ~/sites/$SITENAME/static*
*mkdir ~/sites/$SITENAME/virtualenv*
*cd ~/sites/$SITENAME*
...
[...]
    location / {
        ...
        proxy_pass unix:/tmp/superlists-staging.ottg.eu.socket;
    }
}
----
...
server {
    ...
    location / {
        proxy_set_header Host $host;
        proxy_pass unix:/tmp/SITENAME.socket;
    }
}
----
