...
server {
    ...
    location /static {
        alias /home/harry/sites/book-exmaple-staging.obeythetestinggoat.com/static;
    }
...
ALLOWED_HOSTS = ['book-example-staging.obeythetestinggoat.com']
[...]
----
...
<7> The fabric `sed` command does a string substitution in a file, here it's changing
