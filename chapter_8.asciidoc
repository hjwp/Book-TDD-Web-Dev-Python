...
// staging vs production vs dev distinction. 
...
// remove port 6667 from screenshot
...
django                       setuptools-0.6c11-py3.3.egg
Django-1.5.1-py3.3.egg-info  pip-1.3.1-py3.3.egg             setuptools.pth
easy-install.pth             
----
