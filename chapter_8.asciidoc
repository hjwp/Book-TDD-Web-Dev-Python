...
a way that makes it easy to re-use them later.


[role="sourcecode"]
.superlists/nginx.template.conf
[source,nginx]
----
server {
    listen 80;
    ...
    location /static {
        alias /home/harry/sites/SITE_NAME/static;
    }
...
[role="sourcecode"]
.superlists/gunicorn-upstart.template.conf
[source,bash]
----
...
chdir /home/harry/sites/SITE_NAME/source
exec ../virtualenv/bin/gunicorn superlists.wsgi:application
----
...
[role="sourcecode"]
.superlists/provisioning_notes.md
[source,rst]
----
