...
perhaps enter into that holy credo of programmers, the "flow state".
...
* TODO
* small to medium apps, this approach is fine
* boiled frog analogy
* watch out for tests starting to get slow.  maybe set a limit early on
* it's harder and harder the later you leave it
* so: consider switching just a little sooner than you think.
