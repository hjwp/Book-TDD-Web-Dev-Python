...
"meta-comments"&8212;comments about 'how' the test is working and why--so
...
%%urls.py%%&8212;They're a common source of bugs.
...
other directly (`saved_list` and `list`)&8212;behind the scenes, these
...
`.item_set` is called a "reverse lookup"&8212;it's one of Django's incredibly
