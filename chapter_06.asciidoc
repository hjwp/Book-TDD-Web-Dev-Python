...
provides too much magic, and involves too much of the stack to be used in
a real "unit" test -- you end up writing what are more properly called 
integration tests.  We'll explore this argument further in a later chapter. 
For now we'll use it because it's extremely convenient!
//TODO: where?
...
//TODO: split this out into two tests
...
Now let's use the Django test client.  It's an attribute of the Django
`TestCase`:
...
----
//TODO actually, make this a different test
