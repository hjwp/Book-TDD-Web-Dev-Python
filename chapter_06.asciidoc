...
NOTE: Are you wondering about `other_list`?  A bit like in the tests for
    ...
    a stupid thing to do, and you must go too far down the road of testing
    for all the stupid things you must not do; it's a judgement call, but
    this one feels worth it.
