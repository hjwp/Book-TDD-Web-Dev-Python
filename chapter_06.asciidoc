...
((("functional tests/testing (FT)","cleanup after", id="ix_FTcleanup", range="startofrange")))((("functional tests/testing (FT)","isolation in", id="ix_FTisolation", range="startofrange")))In this chapter we're going to address the problems we discovered at the end
...
((("functional tests/testing (FT)","cleanup after")))((("code", "removing redundant")))We're looking good. Since our new views are now doing most of the work that
