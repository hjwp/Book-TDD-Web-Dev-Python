...
++++
<pre data-type="programlisting" data-code-language="python" class="sourcecode">class ListViewTest(TestCase):

    def test_displays_all_items(self):
        Item.objects.create(text='itemey 1')
        Item.objects.create(text='itemey 2')

        response = self.client.get('/lists/the-only-list-in-the-world/') <a class="co" id="pt_co_getting_to_the_minimum_viable_site_CO3-1" href="#pt_callout_getting_to_the_minimum_viable_site_CO3-1"><img src="callouts/1.png" alt="1"/></a>

        self.assertContains(response, 'itemey 1') <a class="co" id="pt_co_getting_to_the_minimum_viable_site_CO3-2" href="#pt_callout_getting_to_the_minimum_viable_site_CO3-2"><img src="callouts/2.png" alt="2"/></a>
        self.assertContains(response, 'itemey 2') <a class="co" id="pt_co_getting_to_the_minimum_viable_site_CO3-3" href="#pt_callout_getting_to_the_minimum_viable_site_CO3-2"><img src="callouts/2.png" alt="2"/></a></pre>

<dl class="calloutlist">

<dt><a class="co" id="pt_callout_getting_to_the_minimum_viable_site_CO3-1" href="#pt_co_getting_to_the_minimum_viable_site_CO3-1"><img src="callouts/1.png" alt="1"/></a></dt>
<dd><p>Instead of calling the view function directly, we use the Django test
...
very similar API to the one that Selenium uses.</p></dd>

<dt><a class="co" id="pt_callout_getting_to_the_minimum_viable_site_CO3-2" href="#pt_co_getting_to_the_minimum_viable_site_CO3-2"><img src="callouts/2.png" alt="2"/></a></dt>
<dd><p>Instead of using the slightly annoying
...
++++
<pre data-type="programlisting" data-code-language="python" class="sourcecode">from django.conf.urls import include, url
from lists import views as list_views  <a class="co" id="pt_co_getting_to_the_minimum_viable_site_CO4-1" href="#pt_callout_getting_to_the_minimum_viable_site_CO4-1"><img src="callouts/1.png" alt="1"/></a>
from lists import urls as list_urls  <a class="co" id="pt_co_getting_to_the_minimum_viable_site_CO4-2" href="#pt_callout_getting_to_the_minimum_viable_site_CO4-1"><img src="callouts/1.png" alt="1"/></a>
...
<dl class="calloutlist">
<dt><a class="co" id="pt_callout_getting_to_the_minimum_viable_site_CO4-1" href="#pt_co_getting_to_the_minimum_viable_site_CO4-1"><img src="callouts/1.png" alt="1"/></a></dt>
<dd><p>While we&#8217;re at it, we use the <code>import x as y</code> syntax
...
to&#8212;and indeed we will need to later on in the book.</p></dd>
</dl>
++++
