...
in the book's example repo.  It's all to do with my testing
book's tests.  You know, the tests for the tests in the book about testing.
...
//TODO provide a cross-reference
