...
Our unit tests are currently checking HTML by hand,
...
In away, testing for the template name
...
So, let's bring back a minimal "smoke test" that what we're rendering
is actually the home page.
