...
'manage.py' pass:[<phrase role='keep-together'>command:</phrase>]
...
((("view functions, in Django")))((("URLs", "in Django", id="ix_ch03-asciidoc1", range="startofrange")))((("Django", "URLs in", id="ix_ch03-asciidoc2", range="startofrange")))((("Django", "view functions in")))
