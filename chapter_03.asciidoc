...
((("unit tests", "in Django")))((("Django", "unit testing in")))Let's see how to write a unit test for our home page view. Open up the new
...
FAILED (errors=1)
Destroying test database for alias 'default'...((("tracebacks, reading")))
----
