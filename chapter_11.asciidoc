...
((("forms, simple", id="ix_formsimple", range="startofrange")))((("Django", "forms in", see="forms, simple")))((("Django", "forms in", see="forms, advanced")))
...
((("forms, simple", "experimenting with")))Let's do a little experimenting with forms by using a unit test.  My plan is to
...
((("forms, simple", "ModelForm")))((("ModelForm")))What's next?  We want our form to reuse the validation code that we've already
...
((("forms, simple", "validation testing and customizing")))Now let's see if the `ModelForm` has picked up the same validation rules which we
