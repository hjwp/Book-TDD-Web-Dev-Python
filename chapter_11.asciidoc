...
http://django-floppyforms.readthedocs.org/en/latest/[django-floppyforms]
for some help.
...
changing another `Meta` variable, `error_messages`:
...
`test_root_url_resolves_to_` `home_page_view`  with a set of tests that use the
