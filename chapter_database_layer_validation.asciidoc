...
((("{% url %}")))((("templates", "tags", "{% url %}")))((("model-layer validation", "removing hardcoded URLs", id="MLVhard13")))Do you remember those `name=` parameters in 'urls.py'? We just copied
...
and we've taken the opportunity to do a few refactors along the way.((("", startref="MLVhard13")))
