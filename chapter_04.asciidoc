...
((("user interaction testing", id="ix_uitesting", range="startofrange")))((("Selenium", "for user interaction testing", sortas="userinteraction", id="ix_Selenium_for_ui_testing",range="startofrange")))Where were we at the end of the last chapter? Let's rerun the test and find
out:
