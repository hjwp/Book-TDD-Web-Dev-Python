...
((("test-driven development (TDD)", "trivialities of",id="ix_TDDtrivialities",range="startofrange")))I'm imagining several of you, dear readers, have been holding back
...
((("user interaction testing", id="ix_uitesting", range="startofrange")))((("Selenium", "for user interaction testing",id="ix_Selenium_for_ui_testing",range="startofrange")))Where were we at the end of the last chapter? Let's rerun the test and find
out:
...
Let's use that.(((range="endofrange", startref="ix_Selenium_for_ui_testing")))(((range="endofrange", startref="ix_uitesting")))
...
we're comfortable with how everything works. No magic!(((range="endofrange", startref="ix_templates_for_refactoring")))(((range="endofrange", startref="ix_refactoring_with_templates")))
...
((("test-driven development (TDD)", "process recap", id="ix_TDDrecap",range="startofrange")))We've now seen all the main aspects of the TDD process, in practice:
...
((("double-loop TDD")))((("test-driven development (TDD)", "double-loop")))But how does this apply when we have functional tests 'and' unit tests?  Well,
