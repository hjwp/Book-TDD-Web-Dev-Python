...
((("test-driven development (TDD)", "trivialities of",id="ix_TDD trivialities",range="startofrange")))I'm imagining several of you, dear readers, have been holding back
...
**********************************************************************
range="endofrange", startref="ix_TDD trivialities"
...
Let's use that.(((range="endofrange", startref="ix_Selenium_for_ui_testing")))(((range="endofrange", startref="ix_ui_testing")))


Refactoring to Use a Template
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

((("templates", "for refactoring", id="ix_templates_for_refactoring",range="startofrange")))((("refactoring", "with templates", id="ix_refactoring_with_templates",range="startofrange")))What we want to do now is make our view function return exactly the same HTML,
