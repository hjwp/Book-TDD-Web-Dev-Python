...
Create a directory called 'lists/templates'footnote:[Some people like to use another subfolder named after the app (i.e., 'lists/templates/lists') and then refer to the template as
...
http://bit.ly/1iXxWZL[Django tutorial].]
