...
[...]
Traceback (most recent call last):
  File "...goat-book/src/lists/tests/test_views.py", line 34, in
...
Let's change _list.html_, and change the `action` attribute on our form,
so that it points at the existing list URL:


[role="sourcecode"]
.src/lists/templates/list.html (ch14l030)
====
[source,html]
----
...
[role="sourcecode"]
.src/lists/tests/test_views.py (ch14l031)
====
[source,python]
----
