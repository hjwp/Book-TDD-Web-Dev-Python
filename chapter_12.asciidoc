...
<pre data-type="programlisting" data-code-language="python" class="sourcecode skipme small-code">class ListViewTest(TestCase):
    ...
    def test_for_invalid_input_renders_list_template(self):
        ...
        self.assertTemplateUsed(response, 'list.html') <a class="co" id="pt_co_more_advanced_forms_CO1-12" href="#callout_more_advanced_forms_CO1-12"><img src="callouts/6.png" alt="6"/></a>
    def test_for_invalid_input_passes_form_to_template(self):
        self.assertIsInstance(response.context['form'], ExistingListItemForm) <a class="co" id="pt_co_more_advanced_forms_CO1-13" href="#callout_more_advanced_forms_CO1-13"><img src="callouts/7.png" alt="7"/></a>
    def test_for_invalid_input_shows_error_on_page(self):
