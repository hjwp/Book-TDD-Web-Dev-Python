...
Over the next three (short) chapters we'll be implementing validation of user
inputs. 

In terms of content, there's going to be quite a lot of material here that's
quite closely tied to the specifics of Django.  That doesn't mean you won't be
learning anything about testing--there are plenty of little testing tidbits in
here, but perhaps it's more about really getting into the swing of things, the
rhythm of TDD and how we get things done; coding, switching between functional
and unit tests, refactoring, and how it all fits together.
...
promise we'll get right back into some of the real core discussions in TDD
methodology--unit tests vs integrated tests, mocking and more.  I hope you're
in for the long haul!

For now, a little validation.
...
[role="sourcecode"]
.lists/tests/test_models.py (ch12l018)
[source,python]
----
...
[role="sourcecode"]
.lists/templates/base.html (ch12l020)
[source,html]
----
...
[role="sourcecode"]
.lists/tests/test_views.py (ch12l021)
[source,python]
----
...
[role="sourcecode"]
.lists/tests/test_views.py (ch12l029)
[source,python]
----
...
[role="sourcecode"]
.lists/tests/test_views.py (ch12l030-1)
[source,python]
----
class NewListTest(TestCase):
    [...]
...
[role="sourcecode"]
.lists/templates/list.html (ch12l030)
[source,html]
----
...
NOTE: In this section we're performing a refactor at the application level.
    ...
    another look at the diagram from the end of <<chapter-4>> if you need to
    get your bearings.
...
[role="sourcecode"]
.lists/tests/test_views.py (ch12l031)
[source,python]
----
...
[role="sourcecode"]
.lists/tests/test_views.py (ch12l034)
[source,python]
----
class ListViewTest(TestCase):
    [...]
...
[role="sourcecode"]
.lists/templates/home.html (ch12l036-1)
[source,html]
----
...
[role="sourcecode"]
.lists/templates/list.html (ch12l036-2)
[source,html]
----
...
[role="sourcecode"]
.lists/tests/test_models.py (ch12l036-4)
[source,python]
----
