...
https://docs.djangoproject.com/en/1.10/ref/models/options/[Django docs on model
...
NOTE: in Python 2.x versions of Django, the string representation method used
    ...
    Python 3. See the
    https://docs.djangoproject.com/en/1.10/topics/python3/#str-and-unicode-methods[Django docs].
...
https://docs.djangoproject.com/en/1.10/ref/models/instances/#validating-objects[model
validation] and
https://docs.djangoproject.com/en/1.10/ref/forms/validation/[form validation].
...
<5> Think about testing template logic:  any `for` or `if` could have a minimal test.
