...
Traceback (most recent call last):
  File "/workspace/superlists/lists/tests/test_models.py", line 64, in
...
A final aside before we move on. Do you remember I mentioned in chapter 10
that some data integrity errors 'are' picked up on save?  Try doing a
