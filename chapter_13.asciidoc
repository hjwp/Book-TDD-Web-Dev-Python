...
<1> The `test` function defines a test case, a bit like 
    ...
    the test, and the second is a function closure for the body of the test.
...
[subs="specialcharacters,quotes"]
----
$ *python3 manage.py test functional_tests.test_list_item_validation.ItemValidationTest.test_error_messages_are_cleared_on_input*
[...]
