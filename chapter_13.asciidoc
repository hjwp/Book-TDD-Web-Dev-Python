...
NOTE: If you see a message saying '"FATAL ERROR - The following SQL query
    ...
    in the database.  If you want to be rigorous, you should investigate South
    'data migrations', and build one that can enter placeholder values for any
    duplicate items. If you're feeling lazy, just delete the old database!
