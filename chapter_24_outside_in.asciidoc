...
// CSANAD: we removed this part from `test_logged_in_users_lists_are_saved_as_my_lists`
// without any commments or explanation:
//
//        email = "edith@example.com"
//        self.browser.get(self.live_server_url)
//        self.wait_to_be_logged_out(email)
//
// and also the `self.wait_to_be_logged_in(email)`.
// I found it unclear why we no longer need these.
