...
To fix it, let's move down from the presentation layer and URLs
down to the controller layer, Django's view functions.
...
And we fix it, still at the presentation level, in _urls.py_:
...
Sure enough, the FT get a little further because it finds our email in the `<h1>`,
...
[role="sourcecode"]
.src/lists/templates/base.html (ch24l011-2)
====
[source,html]
----
...
[role="sourcecode"]
.src/lists/templates/base.html (ch24l011-1)
====
[source,diff]
----
@@ -57,6 +57,7 @@
...
[role="sourcecode"]
.src/lists/templates/my_lists.html (ch24l010-1)
====
[source,html]
----
{% extends 'base.html' %}
...
[role="sourcecode"]
.src/lists/templates/my_lists.html (ch24l010-2)
====
[source,html]
----
{% extends 'base.html' %}
