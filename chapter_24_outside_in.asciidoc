...
image::images/my-lists-page-sketch.png["A sketch of the My Lists page, showing the users email in the page header, and several lists with a callout saying that we will use the first item text as the hyperlink text for each list."]
...
// TODO: check bootstrap class usages below
...
.Programming By Wishful Thinking, Again
*******************************************************************************

We've been doing a fair bit of "programming by wishful thinking" so far.
...
Outside-In TDD is also sometimes called "programming by wishful thinking"
and you can see why.
...
In that way, it's very much an extension of what we've been doing all along.

TIP: The phrase "programming by wishful thinking" was first popularised by
