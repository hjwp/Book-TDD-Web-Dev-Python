...
((("migrations", "testing", id="ix_migrationstesting", range="startofrange")))Django-migrations and its predecessor South have been around for ages,
...
(((range="endofrange", startref=ix_migrationstesting")))(((range="endofrange", startref="ix_datamigrations")))
******************************************************************************
