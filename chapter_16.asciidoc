...
((("mocks/mocking", "in Python", sortas="python", id="ix_mockingpython", range="startofrange")))The popular 'mock' package was added to the standard library as part of Python
...
(((range="endofrange", startref="ix_mockingpython")))(((range="endofrange", startref="ix_authenticationlogin")))
