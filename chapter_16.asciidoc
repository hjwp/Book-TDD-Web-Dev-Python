...
Using mocks to test external dependencies (and elsewhere)
---------------------------------------------------------
...
TIP: Check out the 
https://docs.djangoproject.com/en/1.8/topics/auth/default/#how-to-log-a-user-in[Django docs on authentication] at this point.


Using mocks to test our own code
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
