...
[...]
AssertionError:
'http://testserver/accounts/login?token=2fa6b817-cefa-4e8e-b757-df3a2bdd511c'
...
.FE........
======================================================================
ERROR: test_returns_new_user_with_correct_email_if_token_exists (accounts.tests.test_authentication.AuthenticateTest)
 ---------------------------------------------------------------------
...
======================================================================
FAIL: test_returns_existing_user_with_correct_email_if_token_exists (accounts.tests.test_authentication.AuthenticateTest)
 ---------------------------------------------------------------------
Traceback (most recent call last):
...
[role="sourcecode small-code"]
.accounts/tests/test_views.py (ch16l038)
[source,python]
----
...
$ pass:quotes[*python manage.py test accounts*]
[...]
AttributeError: <module 'accounts.views' from '/home/harry/Dropbox/Book/source/chapter_16/superlists/accounts/views.py'> does not have the attribute 'auth'
----
...
AssertionError: None != call(<WSGIRequest: GET '/accounts/login?t[71 chars]92'>)
----
...
[...]
AssertionError: call('ack!') != call(<WSGIRequest: GET '/accounts/login?token=[66 chars]68'>)
----
...
[...]
selenium.common.exceptions.NoSuchElementException: Message: Unable to locate element: {"method":"link text","selector":"Log out"}
----
...
save token
add url to email
authenticate using backend (mock?)
