...
((("Boolean comparisons")))((("mocking/mocks", "and Boolean comparisons", sortas="boolean")))((("patch decorator")))So how come our `test_returns_none_if_response_errors` isn't failing?  
