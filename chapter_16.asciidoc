...
== Server-Side Authentication and pass:[<span class="keep-together">Mocking in Python</span>]
...
want to mock out pass:[<span class="keep-together"><code>authenticate</code></span>].
...
++++
<pre data-type="programlisting" data-code-language="python" class="sourcecode">@patch('accounts.authentication.requests.post')  <a class="co" id="pt_co_server_side_authentication_and___mocking_in_python___CO5-1" href="#pt_callout_server_side_authentication_and___mocking_in_python___CO5-1"><img src="callouts/1.png" alt="1"/></a>
class AuthenticateTest(TestCase):

    def setUp(self):
        self.backend = PersonaAuthenticationBackend()  <a class="co" id="pt_co_server_side_authentication_and___mocking_in_python___CO5-2" href="#pt_callout_server_side_authentication_and___mocking_in_python___CO5-2"><img src="callouts/2.png" alt="2"/></a>
    ...
    def test_returns_none_if_response_errors(self, mock_post):
        mock_post.return_value.ok = False  <a class="co" id="pt_co_server_side_authentication_and___mocking_in_python___CO5-3" href="#pt_callout_server_side_authentication_and___mocking_in_python___CO5-3"><img src="callouts/3.png" alt="3"/></a>
        user = self.backend.authenticate('an assertion')
        self.assertIsNone(user)


    def test_returns_none_if_status_not_okay(self, mock_post):
        mock_post.return_value.json.return_value = {'status': 'not okay!'}  <a class="co" id="pt_co_server_side_authentication_and___mocking_in_python___CO5-4" href="#pt_callout_server_side_authentication_and___mocking_in_python___CO5-3"><img src="callouts/3.png" alt="3"/></a>
        user = self.backend.authenticate('an assertion')
        self.assertIsNone(user)</pre>
<dl class="calloutlist">
<dt><a class="co" id="pt_callout_server_side_authentication_and___mocking_in_python___CO5-1" href="#pt_co_server_side_authentication_and___mocking_in_python___CO5-1"><img src="callouts/1.png" alt="1"/></a></dt>
<dd><p>You can apply a <code>patch</code> at the class level as well, and that has the effect
that every test method in the class will have the patch applied, and the
mock injected.</p></dd>

<dt><a class="co" id="pt_callout_server_side_authentication_and___mocking_in_python___CO5-2" href="#pt_co_server_side_authentication_and___mocking_in_python___CO5-2"><img src="callouts/2.png" alt="2"/></a></dt>
<dd><p>We can now use the <code>setUp</code> function to prepare any useful variables which
we&#8217;re going to use in all of our tests.</p></dd>

<dt><a class="co" id="pt_callout_server_side_authentication_and___mocking_in_python___CO5-3" href="#pt_co_server_side_authentication_and___mocking_in_python___CO5-3"><img src="callouts/3.png" alt="3"/></a></dt>
<dd><p>Now each test is only adjusting the setup variables <em>it</em> needs, rather than
setting up a load of duplicated boilerplate&#8212;it&#8217;s more readable.</p></dd>
</dl>
++++
