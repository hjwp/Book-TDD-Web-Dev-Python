...
//TODO: the use of mocks here is a bit superfluous now that we've got ch18/19?
...
//TODO: side_effect can just take an exception class!
...
We have a failing test, so we could just go ahead and make the change,
but it would be better to have a specific test:
...
https://docs.djangoproject.com/en/1.6/ref/contrib/auth/#methods[several
