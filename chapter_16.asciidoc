...
.Django Sessions: How a User's Cookies Tell the Server She Is pass:[<phrase role='keep-together'>Authenticated</phrase>]
**********************************************************************
...
https://github.com/django/django/blob/1.6c1/django/contrib/auth/backends.py#L66[the source] for details.)
