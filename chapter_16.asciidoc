...
3.3
footnote:[If you're using Python 3.2, upgrade! Python 3.4 is almost out, after
all.].//saying Python 3.4 is "almost out" dates the book. Some things are unavoidable, but we we want to try and not have things that make the age of the print book obvious (or the ebook if you haven't updated)
...
//TODO: change "audience" to "http://localhost" instead of just "localhost".//Did you do this? 
...
//TODO - consider making all tests (virtualenv) ones?//Did you do this?
