...
//TODO: make this better so the  html linter doesnt complain
...
//TODO: could hard-code localhost here, and catch the bug in the next chapter?
...
http://bit.ly/SuI0hA[built-in logout view],
 which clears down the user's session and redirects them to a page of our
choice:
