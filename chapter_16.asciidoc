...
((("Python", "mocking in", id="ix_pythonmocking", range="startofrange")))((("mocking", "in Python", id="ix_mockingpython", range="startofrange")))The popular 'mock' package was added to the standard library as part of Python
...
((("mocking", "authenticate")))(I trust you to set up a tests folder with a dunderinit. Don't forget to delete
...
((("decorators")))So what does that give us?
...
(((range="endofrange", startref="ix_mockingpython")))(((range="endofrange", startref="ix_pythonmocking")))(((range="endofrange", startref="ix_authenticationlogin")))
...
((("Boolean comparisons")))((("mocking/mocks", "and Boolean comparisons", sortas="boolean")))So how come our `test_returns_none_if_response_errors` isn't failing?  
...
((("mocking", "Django ORM")))The next thing we have to build is a `get_user` method for our authentication
