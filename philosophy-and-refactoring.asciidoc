...
|=======
2+|Chapter info
|shortname:|philosophy-and-refactoring
|=======

WARNING: Major update released for Selenium 3.
    If you started this book on or before Jan 30th 2017,
    You should do a `pip install --upgrade selenium`, and watch
    out for the new `time.sleeps` below.
...
<4> When we hit Enter, the page will refresh. The `time.sleep` is there to make
    ...
    improve it in <<explicit-waits-chapter>>).
...
specific https://github.com/hjwp/book-example/commits/philosophy-and-refactoring[commits]
...
I should also mention that some people really don't like the Django test
...
* This chapter: https://github.com/hjwp/book-example/tree/philosophy-and-refactoring

* Chapter 5: https://github.com/hjwp/book-example/tree/post-and-database
...
And then, to check your difference from the 'end' of <<philosophy-and-refactoring>>:

[role="skipme"]
----
git diff harry/philosophy-and-refactoring
----
...
https://github.com/hjwp/book-example/archive/philosophy-and-refactoring.zip
