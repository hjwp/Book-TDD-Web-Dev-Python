...
.Warning, Django 5 upgrade in progress!
*******************************************************************************
If you're reading this message, then you're currently reading a preview
version of the third edition of TDDwP.
I'm currently working on upgrading the book to Python 3.12 and Django 5.x.

At the time of writing, I had upgraded all but the last chapter (page pattern)
up to Django 4, and I've just started going from 4->5
