...
//      
//      after that, we can just `pyenv install 3.13`, then navigate to the project directory, and then
//      enter `pyenv local 3.13`. Then reopen the terminal, navigate back to the project directory, and the python version
//      should be 3.13 now.
...
A virtualenv with Python 3.13, Django 5.1, and Selenium 4 in it::
...
Successfully installed [...] django-5.1.4 [...] selenium-4.26.0 [...]
----
