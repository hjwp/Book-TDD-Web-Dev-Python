...
// CSANAD: I noticed two questionable websites at the bottom of the suggested Dive Into Python page.
// I found an https://github.com/hjwp/Book-TDD-Web-Dev-Python/issues/122[open issue]
// suggesting a correction, and although that might be an ad-free website, it is still not the official one.
// Sadly, I found out the author took down most of his work a decade ago
// and there is no official webpage for the book anymore.
