...
((("prerequisite knowledge", id="prereq00")))((("Test-Driven Development (TDD)", "prerequisite knowledge assumed", id="TDDprereq00")))Here
's an outline of what I'm assuming about you and what you already know,
...
((("Python 3", "introductory books on")))I
've tried to write this book with beginners in mind, but if you're new to
...
((("HTML", "tutorials")))I
'm also assuming you have a basic grasp of how the web works--what HTML is,
...
((("Git", "configuring")))I
'll provide step-by-step instructions for Git, but it may be a good idea to
...
((("Django framework", "installation")))((("Selenium", "installation")))We
'll install Django 1.11 and the latest Selenium, Selenium 3:
