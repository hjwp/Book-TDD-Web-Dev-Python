...
.Warning, Django upgrade in progress! (4 -> 5)
*******************************************************************************
If you're reading this message, then you're currently reading a preview
version of the third edition of TDDwP.

I've already worked through and upgraded everything 
(except the last chapter, page pattern),
to Python 3.12 and Django 4.2.

I'm currently working through the upgrade from 4 to Django 5.1.
