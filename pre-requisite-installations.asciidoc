...
NOTE: This book was published before Django 2.0 came out, and as such is
    ...
    but when things do look different on your own PC from what the book says
...
* On Ubuntu I recommend the
  https://launchpad.net/~fkrull/+archive/ubuntu/deadsnakes[Deasnakes PPA].
...
Successfully installed django-1.11.8 selenium-3.8.1
----
