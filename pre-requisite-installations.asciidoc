...
// JAN: This note seems a bit unnecessary. Nowdays I really don't know of anyone that wouldn't use IDE. They're too useful to not use them.
// I know that you don't assume that readers are using IDE and that's fair. Things are different in VS Code comparing to PyCharm.
// IMO, you can ditch it completely or at least the part where you discourage the use of IDEs during this tutorial. To me this sounds like the book is not applicable to real-world problems.
.A Note on IDEs
*******************************************************************************
