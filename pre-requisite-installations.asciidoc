...
The https://docs.djangoproject.com/en/5.1/intro/tutorial01/[official tutorial]
...
A virtualenv with Python 3.12, Django 5.1, and Selenium 4 in it::
...
We'll install Django 5.1 and the latest Seleniumfootnote:[
...
Collecting django<6
  Downloading Django-5.1.1-py3-none-any.whl (8.0 MB)
...
.Warning, Third Edition upgrades in progress! (4 -> 5)
*******************************************************************************
If you're reading this message, then you're currently reading a preview
version of the third edition of TDDwP.

I've already worked through and upgraded almost everything 
(except the last chapter, page pattern),
to Python 3.12 and Django 5.1, so you should find all the code works.
Let me know if you find anything that doesn't!
