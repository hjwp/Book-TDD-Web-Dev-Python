...
----
(superlists) $ *pip install "django==1.11b1" "selenium>3"*
Collecting django==1.11b1
  Using cached Django-1.11b1-py2.py3-none-any.whl
Collecting selenium>3
  Using cached selenium-3.3.1-py2.py3-none-any.whl
Installing collected packages: django, selenium
Successfully installed django-1.11.5 selenium-3.3.1
----
