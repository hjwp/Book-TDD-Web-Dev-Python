...
NOTE: As of May 2014, Django 1.7 was still in beta. If the above command
doesn't work, 
usefootnote:[literally, 1.7.x.zip - that's a link the django project maintains
to the latest code on the 1.7 branch...]
