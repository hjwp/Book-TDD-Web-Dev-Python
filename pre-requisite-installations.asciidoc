...
Collecting django==1.11.13
  Using cached Django-1.11.13-py2.py3-none-any.whl
Collecting selenium<4
  Using cached selenium-3.12.0-py2.py3-none-any.whl
Installing collected packages: django, selenium
Successfully installed django-1.11.13 selenium-3.12.0
----
