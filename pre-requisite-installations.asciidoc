...
Macfootnote:[I wouldn't recommend installing Firefox via homebrew though: brew puts the firefox binary in a strange location, and it confuses selenium.  You can work around it, but it's simpler to just install Firefox in the normal way].
