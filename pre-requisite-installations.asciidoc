...
are now quite pass:[<span class="keep-together">straightforward</span>]:
...
* For macOS or Linux, I recommend you put it in _~/.local/bin_
...
((("Python 3", "installation and setup", "virtualenv set up and activation", id="P3installvirt00")))((("virtual environment (virtualenv)", "installation and setup", id="VEinstall00")))A
...
system-wide, it means you don't need root pass:[<span class="keep-together">permissions</span>].
...
Successfully installed django-1.11.2 selenium-3.3.3
----
