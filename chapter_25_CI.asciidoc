...
each time we push code...as long as the tests pass!((("continuous delivery (CD)")))((("automated deployment", seealso="continuous deployment")))((("deployment", "continuous delivery")))
