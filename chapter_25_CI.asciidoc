...
to see the output of the build job, as in <<gitlab_first_build>>.((("continuous integration (CI)", "building the pipeline", id="ix_CIbld")))
...
Getting debug information out of Selenium can be a bit fiddly.((("Webdriver", "enabling debug logs for")))((("Firefox", "enabling debug logs for")))((("Selenium", "enabling debug logs for")))
...
Firefox is crashing because it can't find a display.((("Firefox", "enabling headless mode for")))
