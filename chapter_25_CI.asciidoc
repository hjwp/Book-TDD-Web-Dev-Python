...
----
$ pass:quotes[*docker build -f infra/Dockerfile.ci -t debug-ci . && docker run -it debug-ci*]
[...]
...
[subs="specialcharacters,macros"]
----
$ pass:quotes[*docker build -f infra/Dockerfile.ci -t debug-ci --platform=linux/amd64 . && \
...
MOZ_CRASHREPORTER_SHUTDOWN="1" MOZ_NO_REMOTE="1" "/usr ... te"
