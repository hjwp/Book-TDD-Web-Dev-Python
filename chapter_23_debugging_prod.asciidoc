...
It looks like our server _can_ now send emails.((("mail.outbox", "not working outside of Django")))
...
In any case, let's see if this whole rickety pipeline works.((("fixtures", "managing in real databases", startref="ix_fxtDB")))
