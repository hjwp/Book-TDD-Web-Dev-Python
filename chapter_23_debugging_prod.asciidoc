...
Let's see if it can't come in handy today!
...
((("environment variables", "secret, alternative method for setting on server", id="ix_envvarset")))((("environment variables")))
((("secret values")))
...
Let's look into that next.((("environment variables", "secret, alternative method for setting on server", startref="ix_envvarset")))
...
it should run the management command instead.
...
or on a server, would be to talk directly to the database.
