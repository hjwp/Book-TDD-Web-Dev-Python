...
NOTE: This next section starts to drift towards what's called "London-school TDD",
    which is a variant on the "Classical" or "Detroit" style of TDD
    that I mostly show in the book.
    We won't get into the details now,
...
$ pass:quotes[*python src/manage.py test accounts*]
[...]
AssertionError: None != call(<WSGIRequest: GET '/accounts/login?t[66 chars[...]
----
...
[role="sourcecode"]
.src/superlists/settings.py (ch19l057)
====
[source,python]
----
