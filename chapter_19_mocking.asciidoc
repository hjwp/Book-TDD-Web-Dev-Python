[[chapter_19_mocking]]
== Mocks: Where and How You Might Use Them

.Warning, Chapter Under Construction.
*******************************************************************************
🚧 Warning, this Chapter is freshly updated for Django 5 + Python 3.12.
...
* TODO: explain that this section is a demonstration,
  and go thru an example of doing the same thing without mocks,
  or maybe with just one mock.
...
The nonmocky way of testing this login view would be
to see whether it does actually log the user in, by checking whether
the user gets assigned an authenticated session cookie in the right circumstances.
...
So, to fully test this view,
you might need to think about writing tests for all three of those cases.
