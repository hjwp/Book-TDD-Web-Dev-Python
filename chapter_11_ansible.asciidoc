...
[role="sourcecode"]
.deploy/ansible-provision.yaml (ch11l001)
====
[source,yaml]
----
---
...
* pull the image form the registry onto the server
    (usually this just involves specifying the image name
...
[role="sourcecode"]
.deploy/ansible-provision.yaml (ch11l002)
====
[source,yaml]
----
---
...
[role="sourcecode"]
.deploy/ansible-provision.yaml (ch11l004)
====
[source,yaml]
...
((("production-ready deployment", "preparing for automation", id="PRDauto10")))
((("automated deployment", "preparing for")))
...
Being able to run our FTs against a container can be very reassuring.
