...
//TODO: consider rephrasing this bit?  From TR: "This section on why our time
//wasn't wasted seems too apologetic in parts. It kind of boils down to the
//reader learning about Django and that it is a good thing to have server side
//validation too."
