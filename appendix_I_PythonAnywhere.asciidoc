...
tool in <<chapter_23_CI>> to run tests on a CI server).
...
is to use screenshots.  Take a look at <<chapter_23_CI>> if you're
...
* Once you get to <<chapter_11_ansible>>, if you want to run Fabric against
