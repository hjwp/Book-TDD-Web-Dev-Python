...
thought we'd go for... an online lists site!  In doing so I'm very much
...
'functional_tests.py'.  Then do a `git diff`, which should tell you that
'functional_tests.py' has changed quite substantially:
