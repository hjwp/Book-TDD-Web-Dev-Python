...
So we can use unit tests to test that we can resolve the URL for the root
of the site ``/'' correctly, and that Django passes it to a view function, and
that that view function
can return the kind of HTML we want to get the functional test to pass.
