...
We appreciate, but do not require, attribution. An attribution usually includes the title, author, publisher, and ISBN. For example: “_Test-Driven Web Development with Python_ by Harry Percival (O’Reilly). Copyright 2014 Some Harry Percival, 978-1-449-36482-3.”
...
link:$$http://oreil.ly/test-driven-python$$[].
