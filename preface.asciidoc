...
* **Django** (`pip-3.3 install --upgrade django==1.5.5`). This is our web
framework. You should make sure you have version 1.5 installed 
footnote:[Django 1.6 is out. I will be upgrading the book soon. For now stick
with 1.5. Differences are minor], and
