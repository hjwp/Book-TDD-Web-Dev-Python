...
((("contact information")))((("questions and comments")))((("comments and questions")))((("feedback")))If you have any comments, questions, or suggestions, I'd love to hear from you.
...
0.3, 2017-02::
    Two new appendices on REST APIs, prerequisites now recommend virtualenv all
    the way through.
...
((("Test-Driven Development (TDD)", "need for", id="TDDneed00")))I'm still quite early on in my programming career.  They say that in any
...
'as well as' unit tests? Come on, that's overdoing it! And this TDD test/minimal-code-change/test cycle? This is just silly! We don't need all these baby
...
process. It produces code that's a pleasure to work with.((("", startref="TDDneed00")))
...
((("errata")))Spotted a mistake or a typo?  The sources for this book are available on
...
((("code examples, obtaining and using")))Code examples are available at https://github.com/hjwp/book-example/; you'll
...
We have a web page for this book, where we list errata, examples, and any additional information. You can access this page at link:$$http://bit.ly/tdd_py_2e$$[].
