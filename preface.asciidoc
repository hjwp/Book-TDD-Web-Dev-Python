...
<<part3>> (Chapters pass:[<a data-type="xref" data-xrefstyle="select:labelnumber" href="#chapter_18_spiking_custom_auth">#chapter_18_spiking_custom_auth</a>–<a data-type="xref" data-xrefstyle="select:labelnumber" href="#chapter_26_hot_lava">#chapter_26_hot_lava</a>]): More advanced testing topics::
