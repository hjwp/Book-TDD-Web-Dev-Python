...
With your help, I hope this can be a better book. So please, please, please do
get in touch with any comments, feedback and suggestions. You can reach me
directly via obeythetestinggoat@gmail.com. I want to know about typos, about
whether you think I'm going too fast or too slow, what you like and don't like,
everything.
...
you know, here's a link from which you can buy the full thing, hint hint...

.Version history
[cols="1,10"]
|================
|0.1| First 4 chapters
|0.2| Adds chapter 5, many typo corrections, and incorporates lots of other
feedback.  Thanks to my editor Meghan Blanchette, Nicholas Tollervey, Hansel
Dunlop, and my mum! 
|================

This version history applies to the paid-for Early Release e-book version 
(thanks again if you've bought that!), not to the Chimera online version. The
bottom entry is the version you're reading now.
