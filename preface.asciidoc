...
and you'll find installation instructions.  To make sure we're using the 
Python3 version of pip, I'll always use `pip-3.3` as the executable from the
command-line
...
PATH: the main Python directory (eg 'c:\Python33') *and* its Scripts subfolder, 
'c:\Python33\Scripts'. You can do
this via
...
below), you should also be able to just run `pip-3.3` and `django-admin.py` from
any folder too.
*******************************************************************************
