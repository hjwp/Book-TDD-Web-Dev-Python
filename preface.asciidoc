...
alias pip3='c:\\Python33\\Scripts\\pip.exe'
----
+
...
below), you should also be able to just run `pip3` and `django-admin.py`
from any folder too.
*******************************************************************************
...
Once that's all done, you'll be able to install Python3 and pip3 with one
simple command:
