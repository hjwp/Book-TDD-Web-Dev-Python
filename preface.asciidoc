...
pass:[<a href="#part1" data-xrefstyle="chap-num-title">#part1</a>] (Chapters 1–6): The basics::
...
pass:[<a href="#part2" data-xrefstyle="chap-num-title">#part2</a>] (Chapters 7–14): Web development essentials:: 
...
pass:[<a href="#part3" data-xrefstyle="chap-num-title">#part3</a>] (Chapters 15–20): More advanced topics::
...
You can also send email to pass:[<a class="email" href="mailto:bookquestions@oreilly.com">bookquestions@oreilly.com</email>].
