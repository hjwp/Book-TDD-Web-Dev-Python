...
and several chapters in Part 3 (up to chapter 22)
...
_Chapters 23 and above are still on Python 3.7 / Django 1.x._
...
<<part3>> (Chapters pass:[<a data-type="xref" data-xrefstyle="select:labelnumber" href="#chapter_18_spiking_custom_auth">#chapter_18_spiking_custom_auth</a>–<a data-type="xref" data-xrefstyle="select:labelnumber" href="#chapter_25_hot_lava">#chapter_25_hot_lava</a>]): More advanced testing topics::
