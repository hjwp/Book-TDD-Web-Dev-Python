...
((("provisioning", "with Ansible", sortas="ansible", id="ix_provisioningansible", range="startofrange")))((("Ansible", id="ix_ansible", range="startofrange")))We used Fabric to automate deploying new versions of the source code to our
...
((("Nginx")))In this section, we install our required software using `apt`, tweak the Nginx
...
((("Gunicorn")))Once again we use a template for our Gunicorn config:
