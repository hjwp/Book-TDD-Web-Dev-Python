...
((("Ansible", id="ansible29")))((("continuous deployment tools")))((("deployment", "continuous deployment tools")))We used Fabric to automate deploying new versions of the source code to our
...
((("Fabric", "moving deployment to Ansible")))We've seen that Ansible can help with some aspects of provisioning, but it can
