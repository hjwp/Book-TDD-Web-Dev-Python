...
hacking in an actual form to be able to enter your email address into the navbar,
...
[role="sourcecode"]
.accounts/templates/login_email_sent.html (ch18l006)
====
[source,html]
----
<html>
...
Django our email server address.  I'm just using my Gmailfootnote:[
...
[role="sourcecode"]
.superlists/settings.py (ch18l007)
====
[source,python]
----
...
Once again, we have a "secret" that we want to avoid keeping directly
in our source code or on GitHub,
...
not optimising database settings.
The fewer things we try to be clever about, the better!
...
[role="sourcecode"]
.accounts/authentication.py (ch18l012)
====
[source,python]
----
import sys
...
[role="sourcecode"]
.superlists/settings.py (ch18l015)
====
[source,python]
----
INSTALLED_APPS = [
...
which thankfully turned out to be irrelevant.
((("", startref="SDcustom18")))
...
Then we'll go back to master and commit just the FT.

Here's a first, simple version of the FT:

[role="sourcecode"]
.functional_tests/test_login.py (ch18l018)
====
[source,python]
----
import re
...
.accounts/tests/test_models.py (ch18l023)
====
[source,python]
----
...
[role="sourcecode"]
.superlists/settings.py (ch18l026)
====
[source,python]
----
INSTALLED_APPS = [
...
[role="sourcecode"]
.accounts/tests/test_models.py (ch18l032)
====
[source,python]
----
...
[role="sourcecode"]
.accounts/tests/test_models.py (ch18l035)
====
[source,python]
----
from accounts.models import Token
