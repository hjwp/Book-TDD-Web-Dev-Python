...
Now, let's open up that _Spec.js_ file and strip it down to a single minimal smoke test:
...
NPM, the massive _node_modules_ folder—and a very steep learning curve.
