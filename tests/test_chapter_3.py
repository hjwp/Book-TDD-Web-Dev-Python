...
class Chapter3Test(ChapterTest):
    ...
    def unit_test_code_cycle(self, pos, test_command_in_listings=True):
    ...
    def test_listings_and_commands_and_output(self):
        ...
        all_unit_tests = self.run_command(self.listings[8])
        ...
        self.unit_test_code_cycle(22)

        self.unit_test_code_cycle(25)
        ...
        self.unit_test_code_cycle(29, test_command_in_listings=False)
        self.unit_test_code_cycle(31, test_command_in_listings=False)
        self.unit_test_code_cycle(33)

        git_diff = self.run_command(self.listings[36])
        for expected_file in ('urls.py', 'tests.py', 'views.py'):
            self.assertIn(expected_file, git_diff)
            self.assertIn(expected_file, self.listings[37])
            self.listings[37].was_checked = True
        commit = self.run_command(self.listings[38])
        self.assertIn('insertions', commit)

        self.unit_test_code_cycle(39, test_command_in_listings=False)
        self.unit_test_code_cycle(41, test_command_in_listings=False)
        self.unit_test_code_cycle(43, test_command_in_listings=False)
        self.unit_test_code_cycle(45, test_command_in_listings=False)
        self.unit_test_code_cycle(47, test_command_in_listings=False)

        self.unit_test_code_cycle(49)
        ...
        git_diff = self.run_command(self.listings[54])
        for expected_file in ('tests.py', 'views.py'):
            self.assertIn(expected_file, git_diff)
            self.assertIn(expected_file, self.listings[55])
            self.listings[55].was_checked = True
        commit = self.run_command(self.listings[56])
        self.assertIn('insertions', commit)
