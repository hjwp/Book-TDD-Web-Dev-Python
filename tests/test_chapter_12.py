...
class Chapter12Test(ChapterTest):
    ...
    def prep_virtualenv(self):
        ...
        if not os.path.exists(virtualenv_path):
            ...
            print(self.sourcetree.run_command(
    ...
    def test_listings_and_commands_and_output(self):
        ...
        #schemamigration_pos = 10
        #assert 'schemamigration' in self.listings[schemamigration_pos]

        self.sourcetree.start_with_checkout(self.chapter_no)
        self.prep_virtualenv()

        # prep database as if from chapter 8
        print('running syncdb')
        self.sourcetree.run_command('git checkout repo/chapter_08')
        self.sourcetree.run_command('mkdir ../database')
        self.sourcetree.run_command('python3 manage.py syncdb --noinput')
        self.sourcetree.run_command('git checkout repo/chapter_11')
