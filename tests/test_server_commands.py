...
class RunServerCommandIntegrationTest(ChapterTest):
    ...
    def test_semifunctional_run_command_sanity_check(self):
...
class WriteFileOnServerIntegrationTest(ChapterTest):
    ...
    def test_semifunctional_write_file_with_root_perms(self):
