...
<xsl:template match="h:section[descendant::h:section[contains(@class, 'notoc')] and not(descendant::h:section[contains(@data-type, 'sect2') and not(contains(@class, 'notoc'))])]" mode="tocgen">
