...
TODO: link to 12-factor page on env vars? 12-factor is certainly a
well-respected source, but also is fairly terse and doesn't attempt to explain
or justify its prescriptions. I'm trying to look for an explaination I prefer,
