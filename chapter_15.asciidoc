...
[role="sourcecode dofirst-ch15l021-1"]
[subs="specialcharacters,quotes"]
----
$ *python manage.py startapp accounts*
----
...
Well,  that gets us on our way.

- models done

- notice how despiked code is much nicer than spiked code

- ft passing was not necessary

TODO: finish chapter properly
