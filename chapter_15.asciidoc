...
((("Selenium", "waits patterns in")))((("waits")))((("explicit waits")))Here's the first of the two "wait" helper functions:
...
((("Fake XMLHttpRequest")))((("QUnit")))((("sinon.js")))Next we need to check the `onlogin` callback, which is called when Persona
