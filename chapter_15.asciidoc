...
((("spiking", "de-spiking")))((("functional tests/testing (FT)", "for de-spiking", sortas="despiking")))((("JavaScript", "de-spiking in")))((("De-spiking")))De-spiking means rewriting your prototype code using TDD.  We now have enough
...
(((range="endofrange", startref="ix_authspiking")))(((range="endofrange", startref="ix_spiking")))(((range="endofrange", startref="ix_javadespiking")))
...
((("mocks/mocking", "sinon.js")))((("mocking library")))((("sinon.js")))"Rolling your own" mocks is possible as we've seen, and JavaScript actually
...
((("mocks/mocking", "checking call arguments")))((("call arguments")))We're not calling the `watch` function correctly yet--it needs to know
