...
((("JavaScript", "spiking with", seealso="spiking", id="ix_javaspiking", range="startofrange")))((("spiking", "with JavaScript", id="ix_spikingjava", range="startofrange")))((("authentication", "spiking", id="ix_authspiking", range="startofrange")))((("spiking", id="ix_spiking", range="startofrange")))((("exploratory coding", seealso="spiking")))Before I wrote this chapter all I'd seen of Persona was a talk at PyCon by Dan
