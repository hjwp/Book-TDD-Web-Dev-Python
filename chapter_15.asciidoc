...
((("spiking", "de-spiking", id="ix_despiking", range="startofrange")))((("functional testing(FT)", "for de-spiking")))((("javascript", "de-spiking in", id="ix_javadespiking", range="startofrange")))De-spiking means rewriting your prototype code using TDD.  We now have enough
...
((("functional testing (FT)", "for evaluating third-party systems")))((("payment systems", "testing for")))
...
((("functional testing (FT),"and asynchronous code", id="ix_FTasynch", range="startofrange")))((("mocking", "callbacks", id="ix_mockingcallbacks", range="startofrange")))((("asynchronous code", id="ix_asynchcode", range="startofrange")))((("sinon.js")))This is what JavaScript's all about folks!  Thankfully, sinon.js really does
