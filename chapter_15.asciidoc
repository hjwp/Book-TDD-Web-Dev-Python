...
((("authentication", "mocking", see="mocking")))((("mocking")))In this chapter, we're going to get pretty deep into a testing
...
((("JavaScript", "spiking and mocking in", see="mocking")))((("Mozilla Persona")))((("Persona (Mozilla)")))((("authentication", "Mozilla Persona")))But which federated authentication system to use?  Oauth?  Openid?  "Login with
...
((("JavaScript", "spiking with", seealso="spiking", id="ix_javaspiking", range="startofrange")))((("authentication", "spiking", id="ix_authspiking", range="startofrange")))((("spiking", id="ix_spiking", range="startofrange")))((("exploratory coding", see="spiking")))Before I wrote this chapter all I'd seen of Persona was a talk at PyCon by Dan
