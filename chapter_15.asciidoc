...
http://stackoverflow.com/questions/16983547/django-problems-with-id-in-custom-usermodel/18458659#18458659[overcome a bug] that later turned out to be irrelevant.((("Ajax")))((("debugging")))
