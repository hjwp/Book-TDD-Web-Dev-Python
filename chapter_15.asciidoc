...
((("mocking", "callbacks", id="ix_mockingcallbacks", range="startofrange")))((("asynchronous code", id="ix_asynchcode", range="startofrange")))((("sinon.js")))((("functional tests/testing (FT), "and asynchronous code", id="ix_ftasynch", range="startofrange")))This is what JavaScript's all about folks!  Thankfully, sinon.js really does
