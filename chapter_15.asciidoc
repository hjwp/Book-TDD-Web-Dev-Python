...
Which federated authentication system should you use?  Oauth?  Openid?  "Login with
...
best known]. //Best known to who? Despite the link, the sentence seems unfinished
...
It's left as an exercise for the reader!  There're more details on the 
...
//TODO: check, is this actually true? //have you checked this?
...
//TODO: move base.html into site-wide folder too? //Have you done/decided this?
