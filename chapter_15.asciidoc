...
((("functional testing (FT),"and asynchronous code")))((("mocking", "callbacks")))((("asynchronous code")))((("sinon.js")))This is what JavaScript's all about folks!  Thankfully, sinon.js really does
...
(((range="endofrange", startref=""ix_mocking")))
