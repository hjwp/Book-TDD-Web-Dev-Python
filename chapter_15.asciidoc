...
A Token model to link emails with a unqiue id
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
[role="sourcecode"]
.accounts/tests/test_views.py (ch15l037)
[source,python]
----
from django.test import TestCase
import accounts  #<2>
...
[role="sourcecode"]
.accounts/tests/test_views.py (ch15l039)
[source,python]
----
from django.test import TestCase
...
[role="sourcecode"]
.accounts/tests/test_views.py (ch15l040)
[source,python]
----
...
[role="dofirst-ch15l042"]
.accounts/tests/test_views.py (ch15l043)
[source,python]
----
...
All crystal-clear? No? Let's do a couple more tests with mocks, to see if they
start to make more sense as we use them more.
