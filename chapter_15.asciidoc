...
((("JavaScript", "spiking and mocking in", see="spiking")))((("JavaScript", "spiking and mocking in", see="mocking")))((("Mozilla Persona")))((("Persona (Mozilla)")))((("authentication", "Mozilla Persona")))But which federated authentication system to use?  Oauth?  Openid?  "Login with
...
((("authentication", "spiking", id="ix_authspiking", range="startofrange")))((("spiking", id="ix_spiking", range="startofrange")))((("exploratory coding", see="spiking")))Before I wrote this chapter all I'd seen of Persona was a talk at PyCon by Dan
...
((("spiking", "de-spiking", id="ix_despiking", range="startofrange")))((("functional testing(FT)", "for de-spiking")))De-spiking means rewriting your prototype code using TDD.  We now have enough
...
(((range="endofrange", startref="ix_authspiking")))(((range="endofrange", startref="ix_spiking")))(((range="endofrange", startref="ix_despiking")))
