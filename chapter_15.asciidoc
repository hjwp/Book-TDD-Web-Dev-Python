...
It's important to notice that there isn't really anything magical going on here,
we're just taking advantage of Python's dynamic nature and scoping rules.

Up until we actually invoke a piece of code, we can modify the variables it has
