...
via 'http://localhost:8000', and not '127.0.0.1'.((("spiking", "logging")))
...
<3> Rather than using a "real" email address and having to click through 
    ...
    http://personatestuser.org[Persona Test User].((("MockMyID")))((("Persona")))((("evaluating third-party systems")))((("payment systems, testing for")))
