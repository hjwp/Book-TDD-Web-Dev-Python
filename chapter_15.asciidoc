...
((("JavaScript", "spiking and mocking in", see="spiking", see="mocking")))((("Mozilla Persona")))((("Persona (Mozilla)")))((("authentication", "Mozilla Persona")))But which federated authentication system to use?  Oauth?  Openid?  "Login with
