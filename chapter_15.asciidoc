...
((("mocking", id="ix_mocking", range="startofrange")))We want our login link's on-click to be bound to a function provided by
...
(((range="endofrange", startref="ix_mocking")))(((range="endofrange", startref="ix_FTasynch")))(((range="endofrange", startref="ix_mockingcallbacks")))(((range="endofrange", startref="ix_asynchcode")))
