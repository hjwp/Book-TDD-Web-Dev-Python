...
((("mocks/mocking", "callbacks", id="ix_mockingcallbacks", range="startofrange")))((("asynchronous code", id="ix_asynchcode", range="startofrange")))((("sinon.js")))This is what JavaScript's all about folks!  Thankfully, sinon.js really does
