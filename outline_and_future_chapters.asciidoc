...
Thanks for reading this far!  I'd really like your input on this
too:  What do you think of the book so far, and what do you think
about the topics I'm proposing to cover in the list below?
...
Chapter 7: User Authentication + the admin site
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
