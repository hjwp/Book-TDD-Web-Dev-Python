...
((("@patch")))((("mocks", "mock_auth variable")))We want to add another test, with another `@patch('accounts.views.auth')`,
...
((("mocks", "functional test for")))I think we're just about ready to try our functional test!  
