...
NOTE: BDD experts should feel free to tell me whether I'm doing things hopelessly wrong
    at this point!
...
And you'll notice all this output is nicely coloured, as shown in <<behave-output>>.
...
resist the urge to just copy-and-paste code from elsewhere, or just from earlier
