...
def step_impl(context):
    raise NotImplementedError(u'STEP: When I create a list with first item "Reticulate Splines"')

@when(u'I add an item "Immanentize Eschaton"')
def step_impl(context):
    raise NotImplementedError(u'STEP: When I add an item "Immanentize Eschaton"')
[...]
----
...
As a sanity check, we can do another run, to see if it 
...
Not Found: /favicon.ico
    Given I am a logged-in user                                 # features/steps/my_lists.py:7 0.094s
    When I create a list with first item "Reticulate Splines"   # features/steps/my_lists.py:20 8.466s
    And I add an item "Immanentize Eschaton"                    # features/steps/my_lists.py:27 0.826s
    And I create a list with first item "Buy milk"              # features/steps/my_lists.py:20 0.404s
    Then I will see a link to "My lists"                        # features/steps/my_lists.py:33 8.274s
