...
And we'll download, unzip and install geckodriver too (it was v 0.16 at
...
/download/v0.16.0/geckodriver-v0.16.0-linux64.tar.gz*
root@server:$ *tar -xvzf geckodriver-v0.16.0-linux64.tar.gz*
