...
((("small vs. big design", id="small07")))((("multiple lists testing", "small design", id="MLTsmall07")))Let's have a think about how we want support for multiple lists to
...
((("Test-Driven Development (TDD)", "overall process of")))How do we use TDD to implement the new design? Let's take another look at
...
((("regression", id="regression07")))Let's translate our scratchpad into a new functional test method, which
