...
((("multiple lists testing", "separate list viewing templates", id="MLTseparate07")))Since the home page and the list view are now quite distinct pages,
...
((("", startref="MLTseparate07")))It may feel like we haven't made much headway since, functionally, the site
