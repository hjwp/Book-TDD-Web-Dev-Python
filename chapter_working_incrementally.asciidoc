...
YAGNI::
    ((("Test-Driven Development (TDD)", "philosophy of", "YAGNI")))((("YAGNI (You ain&#x0027t gonna need it!)")))You ain't gonna need it!  Avoid the temptation to write code that you 
