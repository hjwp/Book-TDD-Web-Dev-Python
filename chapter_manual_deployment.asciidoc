...
servers, and you can get a couple of months' worth of free credit by following
...
[subs="specialcharacters,quotes"]
----
$ *echo "django==1.11b1" > requirements.txt*
...
Downloading/unpacking Django==1.11b1 (from -r requirements.txt (line 1))
[...]
...
TIP: Depending on your firewall configuration, you may even be able to manually
    visit your site at this point, by going to 'http://your.domain.com:8000'
