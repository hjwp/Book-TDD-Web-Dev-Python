...
certainly looks a lot happier.  Let's see if we can actually
see that running from our FT.
...
curl: (7) Failed to connect to superlists-staging.ottg.eu port 80: Connection refused
----
...
Oops, spoke too soon!  Let's take a look manually:
