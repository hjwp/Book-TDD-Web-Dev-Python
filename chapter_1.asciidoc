...
* [line-through]#normal asciidoc line-through#
* pass:[<emphasis role="strikethrough">sarah's passhtru code</emphasis>]
* [strike-through]#asciidoc strike-through instead of line-through#
* [strikethrough]#asciidoc strikethrough all one word#
* [strikethrough line-through]#asciidoc with both!#
* -my attempt to have custom quotes-
* normal list item
