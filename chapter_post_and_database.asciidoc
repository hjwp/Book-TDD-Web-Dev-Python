...
((("database testing", "HTML POST requests", "creating", id="DBIpostcreate05")))((("POST requests", "creating", id="POSTcreate05")))At the end of the last chapter, the tests were telling us we weren't able to
...
((("database testing", "HTML POST requests", "processing")))((("POST requests", "processing")))Because we haven't specified an `action=` attribute in the form, it is
...
((("database testing", "HTML POST requestss", "saving", id="DTpostsave05")))((("HTML", "POST requests", "saving", id="HTMLpostsave05")))Let's adjust the test for our home page POST request, and say we want the view
...
((("", startref="DTpostsave05")))((("", startref="HTMLpostsave05")))And that gets the test passing:
...
((("database testing", "HTML POST requests", "redirecting", id="DThtmlredirect05")))((("HTML", "POST requests", "redirecting", id="HTMLpostredirect05")))But, yuck, that whole `new_item_text = ''` dance is making me pretty unhappy.
...
((("", startref="HTMLpostredirect05")))((("", startref="DThtmlredirect05")))And we should now see five tests pass instead of four:
