...
((("database testing", "HTML POST requests", "redirect following", id="DThtmlredirect05")))((("HTML", "POST requests", "redirect following", id="HTMLpostredirect05")))But, yuck, that whole `new_item_text = ''` dance is making me pretty unhappy.
