...
((("unexpected failures")))An 'unexpected failure'.  
...
*******************************************************************************
((("Test-Driven Development (TDD)", "concepts", "Red/Green/Refactor")))((("Red/Green/Refactor")))((("unit-test/code cycle")))The unit-test/code cycle is sometimes taught as 'Red, Green, Refactor':
