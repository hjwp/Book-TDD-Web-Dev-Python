...
|=======
2+|Chapter info
|shortname:|chapter_post_and_database
|=======
...
It's a demonstration of how TDD can support an iterative style of
...
https://docs.djangoproject.com/en/1.10/intro/tutorial01/[Django
...
commandfootnote:[Are you wondering about when we're going to run "migrate"
...
and in the
https://docs.djangoproject.com/en/1.10/ref/models/fields/[documentation].
...
them in the 
https://docs.djangoproject.com/en/1.10/topics/templates/[Django docs].
