...
// TODO: write a test for the is-invalid stuff at the views layer,
// and talk about higher-level tests giving you more room to refactor
...
[role="sourcecode"]
.src/lists/templates/base.html (ch16l025)
====
[source,diff]
----
@@ -16,10 +16,22 @@
...
At this point we should be down to 30 passing tests:
