...
Let's come back to((("ModelForms", "trade-offs of")))((("frameworks", "trade-off of"))) our scratchpad item:
...
assertions in our `test_views`. ((("Test-Driven Development (TDD)", "test methods and main assertions in test_views")))This isn't to say you should copy-paste these
