...
I'm going to use the example from <<chapter_outside_in,Chapter 18>>. 
...
Not Found: /favicon.ico
    Given I am a logged-in user                                 #
steps/my_lists.py:19 0.09s
    When I create a list with first item "Reticulate Splines"   #
steps/my_lists.py:32 8.46s
    And I add an item "Immanentize Eschaton"                    #
steps/my_lists.py:39 0.82s
    And I create a list with first item "Buy milk"              #
steps/my_lists.py:32 0.40s
    Then I will see a link to "My lists"                        #
steps/my_lists.py:45 8.27s
