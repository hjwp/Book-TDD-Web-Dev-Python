...
((("behavior-driven development (BDD)", "defined")))((("behavior-driven development (BDD)", id="bdd31")))BDD
, 'strictly' speaking, is a methodology rather than a toolset--it's the 
...
((("behavior-driven development (BDD)", "tools for")))((("Gherkin", id="gherkin31")))((("Cucumber")))But
...
((("code examples, obtaining and using")))I
'm going to use the example from <<chapter_outside_in>>. 
...
((("behavior-driven development (BDD)", "functional test using Gherkin syntax")))((("functional tests (FTs)", "using Gherkin syntax", secondary-sortas="Gherkin syntax")))Up
...
((("behavior-driven development (BDD)", "step functions")))We
...
((("behavior-driven development (BDD)", "capturing parameters in steps")))We
'll see how Behave allows you to capture parameters from step descriptions.
Our next step says:
...
((("behavior-driven development (BDD)", "comparing inline-style FT")))I
'm not going to run through the implementation of the feature, but you can 
...
((("behavior-driven development (BDD)", "structured test code encouraged by")))((("functional tests (FTs)", "structuring test code")))This
 is the real appeal, for me: the BDD tool has 'forced' us to structure our
...
((("behavior-driven development (BDD)", "vs. inline comments", secondary-sortas="inline comments")))((("inline comments")))On
