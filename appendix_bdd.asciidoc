...
((("behavior-driven development (BDD)", "defined")))BDD, 'strictly' speaking, is a methodology rather than a toolset--it's the 
...
((("behavior-driven development (BDD)", "tools for")))((("Gherkin")))((("Cucumber")))But the term has become closely associated with a particular set of tools for
...
((("behavior-driven development (BDD)", "directory creation")))We make a directory for our BDD "features," add a steps directory (we'll find
...
((("behavior-driven development (BDD)", "functional test using Gherkin syntax")))((("functional tests (FTs)", "using Gherkin syntax", secondary-sortas="Gherkin syntax")))((("Gherkin")))Up until now, we've been writing our FTs using human-readable comments
