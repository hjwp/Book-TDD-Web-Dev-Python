...
going to use the example from <<chapter_23_outside_in>>. 
...
((("behavior-driven development (BDD)", "comparing inline-style FT")))I'm
...
<<chapter_24_page_pattern>> of the book, I present an example of the "Page
