...
FAIL: test_adding_notes (functional_tests.tests.NewVisitorTest)
 ---------------------------------------------------------------------
Traceback (most recent call last):
  File "/home/harry/Dropbox/book/source/chapter_9/superlists/functional_tests/tests.py", line 137, in test_adding_notes
    self.check_for_row_in_list_table("1: Buy milk")
  File "/home/harry/Dropbox/book/source/chapter_9/superlists/functional_tests/tests.py", line 35, in check_for_row_in_list_table
...
----
  File "/home/harry/Dropbox/book/source/chapter_9/superlists/functional_tests/tests.py", line 155, in test_adding_notes
    self.browser.find_element_by_css_selector('input[type=submit]').click()
[...]
...
Before we move on though, let's do a tiny bit of prettification.  Our addition
of the 'edit notes' link to the table has made it look a bit awkard
