...
as befits a book about testing, every single code listing in this book is
tested by an automated test suite.  I even have tests for the tests. So, before
you blame me, do check closely... Did you really do 'exactly' what I suggested?
Are you sure there's not a missing comma or trailing slash or a file in the
