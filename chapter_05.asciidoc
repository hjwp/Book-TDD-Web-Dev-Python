...
NOTE: I've used this unit test in a very verbose style, as a way of introducing
the Django ORM. You can actually write a much shorter test for a model class,
which we'll see later in the book.
...
//TODO: convert to ch05l028 to fix multi-imports
...
//TODO: convert to git listing, to be able to insert at right spot
