...
((("user input, saving", id="ix_userinput", seealso="POST requests", seealso="migrations", range="startofrange")))We want to take the to-do item input from the user and send it to the server,
...
((("ORM (Object-Relational Mapper)", id="ix_ORM", range="startofrange")))((("Django", "Object-Relational Mapper (ORM)", id="ix_Django_ORM", range="startofrange")))An Object-Relational Mapper (ORM) is a layer of abstraction for data stored in 
...
(((range="endofrange", startref="ix_djangomig")))(((range="endofrange", startref="ix_migrations")))(((range="endofrange", startref="ix_Django_ORM")))(((range="endofrange", startref="ix_ORM")))So let's do a commit for our first ever model!
