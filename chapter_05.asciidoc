...
about a piece of code that makes you want to rewrite it. Jeff Atwood has
...
returned as a list-like object called a `QuerySet`, from which we can extract individual objects, and also call further
functions, like `.count()`. We then
