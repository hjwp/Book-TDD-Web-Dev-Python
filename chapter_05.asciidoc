...
https://docs.djangoproject.com/en/1.8/ref/request-response/[request and
...
+++++
<pre data-type="programlisting" data-code-language="python" class="sourcecode">def home_page(request):
    if request.method == 'POST':
        new_item_text = request.POST['item_text']  <a class="co" id="pt_co_saving_user_input_CO2-1" href="#pt_callout_saving_user_input_CO2-1"><img src="callouts/1.png" alt="1"/></a>
        Item.objects.create(text=new_item_text)  <a class="co" id="pt_co_saving_user_input_CO2-2" href="#pt_callout_saving_user_input_CO2-2"><img src="callouts/2.png" alt="2"/></a>
    else:
        new_item_text = ''  <a class="co" id="pt_co_saving_user_input_CO2-3" href="#pt_callout_saving_user_input_CO2-1"><img src="callouts/1.png" alt="1"/></a>

    return render(request, 'home.html', {
        'new_item_text': new_item_text,  <a class="co" id="pt_co_saving_user_input_CO2-4" href="#pt_callout_saving_user_input_CO2-1"><img src="callouts/1.png" alt="1"/></a>
    })</pre>
<dl class="calloutlist">

<dt><a class="co" id="pt_callout_saving_user_input_CO2-1" href="#pt_co_saving_user_input_CO2-1"><img src="callouts/1.png" alt="1"/></a></dt>
<dd><p>We use a variable called <code>new_item_text</code>, which will either
hold the POST contents, or the empty string.</p></dd>

<dt><a class="co" id="pt_callout_saving_user_input_CO2-2" href="#pt_co_saving_user_input_CO2-2"><img src="callouts/2.png" alt="2"/></a></dt>
<dd><p><code>.objects.create</code> is a neat shorthand for creating a new <code>Item</code>, without
needing to call <code>.save()</code>.</p></dd>
</dl>
++++
