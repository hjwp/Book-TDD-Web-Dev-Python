...
((("triangulation")))((("duplicates", "eliminating")))((("refactoring")))((("Red, Green, Refactor")))(((range="endofrange", startref="ix_templatespythonvar")))Now we get to the `self.fail('Finish the test!')`.  If we extend our FT to 
