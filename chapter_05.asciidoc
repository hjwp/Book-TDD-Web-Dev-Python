...
https://docs.djangoproject.com/en/1.6/intro/tutorial01/#playing-with-the-api[Django
...
image::images/need_some_test_isolation.png[OperationalError at / no such table: lists_item]
