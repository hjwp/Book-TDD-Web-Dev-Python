...
a class attribute, `.objects`, and we use the simplest possible query, `.all()`,
...
NOTE: I've used this unit test as a way of introducing the Django ORM. You
can actually write a much shorter test for a model class, which we'll see
later in the book.
...
* [strikethrough]#Don't save blank items for every request#
