...
So how can we test that our view is passing in the correct value for 
...
It is definitely possible that I've made a mistake. But you should know that,
as befits a book about testing, every single code listing, command, and
expected console output in the book is verified by an automated test suite I
built. So, before you blame me, do check closely... Did you really do 'exactly'
what I suggested? Are you sure there's not a missing comma or trailing slash or
a file in the wrong place or 'something'?

Send me a note to obeythetestinggoat@gmail.com if you think you've found a
real mistake.
*******************************************************************************
...
.Terminology 2: Unit tests vs Integration tests, and the database
*******************************************************************************
...
"Integration Test", because it doesn't only test our code, but also relies on
...
point of view.  We'll talk more about the distinction between unit tests and
integration tests at the end of the book.
*******************************************************************************
...
In any case, the `.text` attribute is now a special attribute, so it does get
saved, and the tests pass:
...
Now I'm not a rigid purist when it comes to unit tests, so I don't mind bending
this rule now and again, but this really does feel like a good place to
