...
((("triangulation")))((("duplicates", "eliminating")))((("refactoring", "Red, Green, Refactor")))((("Red, Green, Refactor")))(((range="endofrange", startref="ix_templatespythonvar")))Now we get to the `self.fail('Finish the test!')`.  If we extend our FT to 
...
once you get three occurrences, it's time to remove duplication.((("DRY (don't repeat yourself)")))
...
((("helper functions/methods")))Back to our functional test refactor: we could use an inline function, but that
...
tutorial], which has an excellent intro to them. ((("unit tests", "vs. integrated tests", sortas="integratedtests")))((("integrated tests", "vs. unit tests", sortas="unittests")))
...
((("Django", "migrations", id="ix_djangomig", range="startofrange")))((("migrations", seealso="data migrations", id="ix_migrations", range="startofrange")))The next thing that happens is a database error:
...
(((range="endofrange", startref="ix_djangomig")))(((range="endofrange", startref="ix_migrations")))(((range="endofrange", startref="ix_Django_ORM")))(((range="endofrange", startref="ix_ORM")))(((range="endofrange", startref="ix_objectrelationalmapper")))So let's do a commit for our first ever model!
...
((("POST requests", "redirect after")))((("redirects")))But, yuck, that whole `new_item_text = ''` dance is making me pretty unhappy.
