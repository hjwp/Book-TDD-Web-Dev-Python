...
((("ORM (Object-Relational Mapper)", id="ix_ORM")))((("Django", "Object-Relational Mapper (ORM)", id="ix_Django_ORM", range="startofrange")))((("Object-Relational Mapper (ORM)", id="ix_objectrelationalmapper", range="startofrange")))An Object-Relational Mapper (ORM) is a layer of abstraction for data stored in 
...
page saying "no such table: lists_item", as in <<operationalerror>>.(((range="endofrange", startref="ix_templatesrendering")))(((range="endofrange", startref="ix_renderingtemplates")))
