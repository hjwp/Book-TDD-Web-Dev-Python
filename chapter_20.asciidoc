...
((("CI server", see="continuous integration")))((("functional testing (FT)", "automation of", see="continuous integration")))((("continuous integration", id="ix_continuousintegration", range ="startofrange")))As our site grows, it takes longer and longer to run all of our functional
...
((("Jenkins Security", "installing")))((("Jenkins Security", seealso"continuous integration)))((("continuous integration", "installing Jenkins")))((("Jenkins Security", id="ix_jenkins", range="startofrange")))There are several hosted-CI services out there that essentially provide you
...
((("Jenkins Security", "configuring")))((("continuous integration", "configuring Jenkins")))The first thing we'll do is set up some authentication, since our server is
...
((("Jenkins Security", "adding required plugins")))((("continuous integration", "adding required plugins")))Next we install a few plugins, to help us work with Git, Python, and virtual
