...
But it won't actually work, because we don't know how to save a list owner yet: (((range="endofrange", startref="ix_tddviews")))
...
to use better test isolation...(((range="endofrange", startref="ix_tddoutside")))
