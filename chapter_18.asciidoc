...
NOTE: this chapter has not yet been updated for the new edition.  However,
    if you have a version of the `create_pre_authenticated_session` helper
    function from the previous chapter, and it works, you should be able
...
minimal pass:[<span class="keep-together">placeholder:</span>]
