...
Unit tests for our initialize function
++++++++++++++++++++++++++++++++++++++
...
----
Died on test #1 @file:///home/harry/Dropbox/book/source/chapter_14/superlists/accounts/static/tests/tests.html:20 : Superlists is not defined
----
...
----
Died on test #1 @file:///home/harry/Dropbox/book/source/chapter_14/superlists/accounts/static/tests/tests.html:20 : Superlists is null
----
...
want.  We're called `navigator.id.request` always, instead of only
...
----
Died on test #1 @file:///home/harry/Dropbox/book/source/chapter_14/superlists/accounts/static/tests/tests.html:20 : navigator.id.doSomethingElse is not a function
----
...
A quick check on the FT ... Doesn't get any further unfortunately.  So,
let's see what happens in the debug console if we do things manually:

----
[01:36:54.572] Error: navigator.id.watch must be called before navigator.id.request @ https://login.persona.org/include.js:8
----
