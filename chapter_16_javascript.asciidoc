...
////
OK NEW PLAN
- we use a regex to parse list items,
and add sparkles to the ones we like
////
...
$ *rm -r src/lists/static/tests/lib*
$ *rm src/lists/static/tests/spec/SpecHelper.js*

# move the example tests "Spec" file to a more central location
$ *mv mv src/lists/static/tests/spec/PlayerSpec.js src/lists/static/tests/Spec.js*
