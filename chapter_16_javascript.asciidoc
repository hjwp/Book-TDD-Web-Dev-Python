...
.lists/static/lists.js (ch16l014)
====
[source,html]
----
const textInput = document.querySelector("#id_text");
...
[role="sourcecode"]
.lists/static/lists.js (ch16l017)
====
[source,javascript]
----
console.log("lists.js loading");
...
[role="sourcecode"]
.lists/static/tests/tests.html (ch16l018)
====
[source,javascript]
----
  it("sense-check our html fixture", () => {
...
[role="sourcecode"]
.lists/static/lists.js (ch16l019)
====
[source,javascript]
----
const initialize = () => {
...
<4> Here's why `textInput` and `errorMsg` can't be constants:
