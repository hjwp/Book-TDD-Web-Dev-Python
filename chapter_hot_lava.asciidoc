...
((("testing best practices")))((("Test-Driven Development (TDD)", "test goals")))Let
's step back and have a think about what benefits we want our tests to
...
Integrated tests are a scam::
    ((("integrated tests", "benefits and drawbacks of")))J
.B. Rainsberger has a
