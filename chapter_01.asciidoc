...
(((functional test)))That's our first 'functional test' (FT); I'll talk more about what I mean by
...
((("Git", "repository setup", id="ix_"Git", "repository setup", range="startofrange)))((("version control system (VCS)", id="ix_version control system (VCS)", range="startofrange")))((("VCS (version control system)", id="ix_VCS (version control system)", range="startofrange")))There's one last thing to do before we finish the chapter: start to commit our
...
well-deserved pat on the back before moving on to <<chapter-2>>.(((range="endofrange, startref=ix_"Git", "repository setup")))(((range="endofrange, startref="version control system (VCS)")))(((range="endofrange, startref=ix_"VCS (version control system)")))
