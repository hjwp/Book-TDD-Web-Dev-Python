...
_lists.html_ pass:[<span class="keep-together">template</span>]:
...
convenient for what I want to pass:[<span class="keep-together">demonstrate</span>].
*******************************************************************************
...
<2> Similarly, we only start mocking our helper function 'after' we know the
    ...
    the given object with a mock pass:[<span class="keep-together">version</span>].
...
Read on, pass:[<span class="keep-together">Macduff</span>].((("", startref="RESTbuild32")))
