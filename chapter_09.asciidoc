...
First off, it's always nice, when doing refactoring, to have a fully passing test
suite.  We've just written a test with a deliberate failure. Let's
...
* In general, never refactor against failing tests.  
    * The FT you're currently working on doesn't count.
