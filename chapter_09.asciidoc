...
((("automation, in deployment", seealso="deployment", id="ix_autodeploy", range="startofrange")))((("deployment", "automating", id="ix_deploymentauto", range="startofrange")))Automating deployment is critical for our staging tests to mean anything.
...
((("Fabric", "installing")))Fabric is a tool which lets you automate commands that you want to run on
...
(in fact I find it hard to stop myself from making little 1970s computer '<brrp,
...
((("Git", "tags")))One final bit of admin.  In order to preserve a historical marker,
