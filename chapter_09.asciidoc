...
TODO: refactor two URLs to use {% url %} at this point
TODO: refactor uses of URLs in views too.
...
lists/templates/list.html:        <input id="id_new_item" name="item_text"
...
lists/templates/list.html:        <input id="id_text" name="item_text"
placeholder="Enter a to-do item" />
----
