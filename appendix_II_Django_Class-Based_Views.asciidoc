...
the options], Django has a generic view called ++FormView++&8212;let's see how that
goes:
...
little bit less magic&8212;"explicit is better than implicit", as the Zen of
