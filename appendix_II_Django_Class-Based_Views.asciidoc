[[appendix2]]
[appendix]
Django Class-Based Views((("Django", "class-based views", id="ix_Djangocbviews", range="startofrange", seealso="class-based views")))((("class-based views", id="ix_cbviews", range="startofrange")))
------------------------
...
((("class-based views", "generic views")))There's a difference between class-based views and class-based 'generic' views.
...
working.
(((range="endofrange", startref=""ix_Djangocbviews")))(((range="endofrange", startref=""ix_"cbviews")))
