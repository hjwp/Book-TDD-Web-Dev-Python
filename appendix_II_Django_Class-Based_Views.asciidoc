[[appendix2]]
[appendix]
Django Class-Based Views((("Django", "class-based views", id="ix_Djangocbviews", seealso="class-based views", range="startofrange")))((("class-based generic views", id="ix_cbgenviews", range="startofrange")))((("class-based views")))
------------------------
