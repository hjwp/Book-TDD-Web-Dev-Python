...
of that chapter, our views were still using functions.((("Django", "class-based views", id="ix_Djangocbviews", seealso="class-based views", range="startofrange")))((("class-based generic views", id="ix_cbgenviews", range="startofrange")))((("class-based views")))
...
working.
(((range="endofrange", startref="ix_Djangocbviews")))(((range="endofrange", startref="ix_cbgenviews")))
