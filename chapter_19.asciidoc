...
this:
    ...
    def save(self):
        create_new_list(first_item_text=self.cleaned_data['text'])




    @patch('lists.forms.create_new_list')
    def test_save_creates_new_list_from_cleaned_data(
        self, mock_create_new_list
    ):
        form = NewListForm()
        ...
        mock_create_new_list.assert_called_once_with(
...
save the owner:
    ...
    @patch('lists.forms.create_new_list')
    def test_save_creates_list_with_owner_if_user_authenticated(
        self, mock_create_new_list
    ):
        form = NewListForm()
        form.cleaned_data = {'text': 'new item text'}
...
class CreateNewListTest(TestCase):
    ...
    def test_creates_list_and_item(self):
        create_new_list(new_item_text='new item text')
...
----
    ...
    def test_optionally_saves_owner(self):
        user = User.objects.create()
        create_new_list(first_item_text='new item text', owner=user)
        new_list = List.objects.first()
