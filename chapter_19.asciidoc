...
repo was at https://github.com/jonkemp/qunit-phantomjs-runner
...
TODO: talk about the idea of getting jenkins to automatically deploy to 
staging?  (thanks Paolo for the suggestion)
