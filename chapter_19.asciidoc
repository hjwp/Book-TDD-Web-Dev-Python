...
<pre data-type="programlisting" data-code-language="python" class="sourcecode">    @patch('lists.views.List')
    def test_list_owner_is_saved_if_user_is_authenticated(self, mockList):
        ...
        def check_owner_assigned():  <a class="co" id="co_test_isolation__and__listening_to_your_tests__CO2-1" href="#callout_test_isolation__and__listening_to_your_tests__CO2-1"><img src="callouts/1.png" alt="1"/></a>
            self.assertEqual(mock_list.owner, request.user)  <a class="co" id="co_test_isolation__and__listening_to_your_tests__CO2-2" href="#callout_test_isolation__and__listening_to_your_tests__CO2-2"><img src="callouts/1.png" alt="1"/></a>
        mock_list.save.side_effect = check_owner_assigned  <a class="co" id="co_test_isolation__and__listening_to_your_tests__CO2-3" href="#callout_test_isolation__and__listening_to_your_tests__CO2-3"><img src="callouts/2.png" alt="2"/></a>

        new_list(request)

        mock_list.save.assert_called_once_with()  <a class="co" id="co_test_isolation__and__listening_to_your_tests__CO2-4" href="#callout_test_isolation__and__listening_to_your_tests__CO2-4"><img src="callouts/3.png" alt="3"/></a></pre>
<dl class="calloutlist">
<dt><a class="co" id="callout_test_isolation__and__listening_to_your_tests__CO2-1" href="#co_test_isolation__and__listening_to_your_tests__CO2-1"><img src="callouts/1.png" alt="1"/></a></dt>
...
<dt><a class="co" id="callout_test_isolation__and__listening_to_your_tests__CO2-2" href="#co_test_isolation__and__listening_to_your_tests__CO2-2"><img src="callouts/2.png" alt="2"/></a></dt>
...
<dt><a class="co" id="callout_test_isolation__and__listening_to_your_tests__CO2-3" href="#co_test_isolation__and__listening_to_your_tests__CO2-3"><img src="callouts/3.png" alt="3"/></a></dt>
