...
((("mocks/mocking", "for isolation", id="ix_mocksforisolation", range="startofrange")))((("test isolation", "mocks/mocking for", id="ix_testisolationmocks")))Lists don't have owners yet, but we can let the views layer tests pretend they
...
((("integrated test", "vs. integration test", sortas="integration")))
...
((("test isolation", "collaborators", id="ix_testisolationcollab", range="startofrange")))In order to rewrite our tests to be fully isolated, we need to throw out or old
...
((("test isolation", "ORM code", id="ix_testisolationORM", range="startofrange")))((("ORM code", id="ix_ORM", range="startofrange")))We'll need the form's save method to create a new list, and a new item based on
...
(((range="endofrange", startref="ix_testisolationformslayer")))((("helper methods")))
OK
----
...
(((range="endofrange", startref="ix_testisolationORM")))(((range="endofrange", startref="ix_ORM")))
*******************************************************************************
...
((("test isolation", "views layer")))Two of our old integrated tests for the views layer are failing. What's happening?
...
((("test isolation", "cleanup after", id="ix_testisolationcleanup", range="startofrange")))((("integrated tests")))Now everything is working, we can remove some redundant tests, and decide
...
your code lie.((("refactoring", "in test isolation", sortas="testisolation)))((("test isolation", "refactoring")))
...
(((range="endofrange", startref="ix_testisolation")))(((range="endofrange", startref="ix_integratedtests")))((("test types, pros and cons")))((("functional testing (FT)", "pros and cons")))((("integrated tests", "pros and cons")))((("isolated tests", "pros and cons")))((("ORM code")))((("test isolation", "ORM code")))
