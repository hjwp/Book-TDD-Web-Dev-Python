...
++++
<formalpara role="sourcecode skipme"><title>lists/tests/test_views.py</title><para>
<programlisting language="diff" role="sourcecode skipme">-from lists.views import new_list, new_list2
