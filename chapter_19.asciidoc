...
[role="sourcecode"]
.functional_tests/base.py (ch19l006)
[source,python]
----
import os
...
[role="sourcecode"]
.functional_tests/base.py (ch19l007)
[source,python]
----
...
[role="sourcecode"]
.functional_tests/base.py (ch19l008)
[source,python]
----
...
<<chapter-2,Chapter 2>>?  Do you remember I mentioned it was unreliable?
...
[role="sourcecode"]
.functional_tests/test_my_lists.py (ch19l012)
[source,python]
----
    # She sees that her list is in there, named according to its
    # first list item
...
[role="sourcecode"]
.functional_tests/base.py (ch19l013)
[source,python]
----
import time
...
[role="sourcecode"]
.functional_tests/base.py (ch19l014)
[source,python]
----
[...]
DEFAULT_WAIT = 5
...
[role="sourcecode"]
.functional_tests/test_my_lists.py (ch19l015)
[source,python]
----
    self.wait_for(
