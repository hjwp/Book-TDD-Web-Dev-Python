...
your code lie.((("refactoring", "in test isolation", sortas="testisolation")))((("test isolation", "refactoring in")))
...
(((range="endofrange", startref="ix_testisolation")))(((range="endofrange", startref="ix_integratedtests")))((("test types, pros and cons")))((("functional tests/testing (FT)", "pros and cons")))((("integrated tests", "pros and cons")))((("isolated tests", "pros and cons")))((("ORM code")))((("test isolation", "ORM code")))
