...
((("cutting corners")))((("Testing Goat")))I think the reason the phrase "Obey the Testing Goat" first grabbed me when I
...
((("continuous integration (CI)")))Another area that takes real hard work is continuous integration.  You saw in
...
Take Pride in Tour Tests, as You Do in Your Code
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
