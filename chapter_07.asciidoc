...
((("CSS (Cascading Style Sheets) framework", seealso="Bootstrap")))Design is hard, and doubly so now that we have to deal with mobile, tablets, and
...
((("Bootstrap", "table styling")))((("table styling")))((("layout and style", "Bootstrap for", see="Bootstrap")))The table text also looks too small compared to the rest of the page now.
