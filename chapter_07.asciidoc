...
(((range="endofrange", startref="ix_layoutandstylestatic")))(((range="endofrange", startref="ix_Djangocollectstatic")))(((range="endofrange", startref="ix_collectstatic")))Anyway, now we know how to collect all the static files into a single folder,
