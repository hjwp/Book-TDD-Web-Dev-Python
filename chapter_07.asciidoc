...
((("functional test (FT)", "for layout and style", id="ix_FTlayoutstyle", range="startofrange")))Our site is undeniably a bit unattractive at the moment
...
((("commits", "in layout and design testing")))Let's commit just the FT:
...
after this one.((("git reset --hard")))((("warnings", "git reset --hard")))


Prettification: Using a CSS Framework
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

((("CSS (Cascading Style Sheets) framework")))((("CSS (Cascading Style Sheets) framework", seealso="Bootstrap")))Design is hard, and doubly so now that we have to deal with mobile, tablets, and
...
((("Bootstrap", "installing")))You can find bootstrap at http://getbootstrap.com/.
...
((("Bootstrap", "rows and columns in")))Finally, let's actually use some of the Bootstrap magic! You'll have to read
...
((("Django", "static files in")))((("static files")))Django, and indeed any web server, needs to know two things to deal with static
files:
...
((("Bootstrap", "large inputs")))((("large inputs")))The jumbotron is a good start, but now the input box has tiny text compared to
...
((("Bootstrap", "table styling")))((("table styling")))((("layout and design", "Bootstrap for", see="Bootstrap")))The table text also looks too small compared to the rest of the page now.
...
((("CSS (Cascading Style Sheets) framework", "where Bootstrap won't work")))((("layout and design", "using our own CSS in")))Finally I'd like to just offset the input from the title text slightly. There's
...
((("commits", "in layout and design")))That's it! Definitely time for a commit:
...
((("Django", "collectstatic", id="ix_Djangocollectstatic", range="startofrange")))((("static directories", id="ix_staticdirectories", range="startofrange")))((("collectstatic", id="ix_collectstatic", range="startofrange")))We saw earlier that the Django dev server will magically find all your static
...
(((range="endofrange", startref="ix_Djangocollectstatic")))(((range="endofrange", startref="ix_collectstatic")))(((range="endofrange", startref="ix_staticdirectories")))Anyway, now we know how to collect all the static files into a single folder,
