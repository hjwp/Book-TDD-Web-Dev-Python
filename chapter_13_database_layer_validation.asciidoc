...
// Update: Checked and last time we touched models.py was in chapter 07 where we did
// run makemigrations and then `migrate` in chapter 08. No changes to the model since.
// Can I delete this part "There's a way of checking whether the constraint..."?
// CSANAD, update#2: after discussing this at
// https://github.com/hjwp/Book-TDD-Web-Dev-Python/pull/302#discussion_r1717026832
// I'm commenting the paragraph out.
