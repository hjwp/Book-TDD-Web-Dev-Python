...
TIP: Choose WSL as your backend on Windows,
    ...
    in the background. YOu should be able to run all the `docker` CLI commands
    from a normal Windows console.


// TODO: appendix or link to more detailed instructions for WLS use?
...
// XUAN: would love to have more explantion for this, especially on how you arrive at the diagnosis of the problem, and why we don't want that.
// That can help with understanding the following section of mounting the files inside the container as well.
