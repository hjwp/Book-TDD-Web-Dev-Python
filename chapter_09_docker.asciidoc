...
a virtualenv((("Django framework", "installing in virtualenv in container image", id="ix_Djainctnrimg")))((("containers", "installing Django in virtualenv in container image", id="ix_cntnrDja"))) is useful in a deployed environment to make
