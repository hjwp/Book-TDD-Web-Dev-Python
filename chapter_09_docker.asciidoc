...
a virtualenv((("Django framework", "installing in virtualenv in container image", id="ix_Djainctnrimg"))) is useful in a deployed environment to make
...
you should find that the Docker process has been terminated.((("Django framework", "installing in virtualenv in container image", startref="ix_Djainctnrimg")))
