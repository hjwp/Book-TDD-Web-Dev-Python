...
((("debugging", "server-side", "setting secret environment variables")))((("environment variables")))((("secret values")))In
<<chapter_automate_deployment_with_fabric>>, we've seen one way of setting secret
