...
waiting to respond.  It also passes on the Host header, so that the
ALLOWED_HOSTS check will work.
...
TODO:  jump thru extra hoop of forgetting to do the proxy_set_header?
...
$ pass:quotes[*STAGING_SERVER=superlists-staging.ottg.eu python manage.py test functional_tests*]
[...]
AssertionError: 106.5 != 512 within 3 delta
FAILED (failures=1)
----
