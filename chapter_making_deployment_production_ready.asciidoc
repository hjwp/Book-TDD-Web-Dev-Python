...
((("production-ready deployment", "preparing for automation", id="PRDauto10")))Let's recap our provisioning and deployment procedures:
...
((("", startref="PRDauto10")))Our source tree will now look something like this:
