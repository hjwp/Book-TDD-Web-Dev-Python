...
standardising around using the convention of a file called *.env* in the
project root.

First we add it *.env* to our *.gitignore* -- this file is going to be used
...
DJANGO_SECRET_KEY=hibogdctu8y55mr8xut3d1x86qmq3p7nwv3iyleqn6caodd5lm
----
...
EnvironmentFile=/home/elspeth/sites/superlists-staging.ottg.eu/.env  <3>
