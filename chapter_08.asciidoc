...
Progress!
footnote:[If you don't see "Welcome to nginx!", it may be because your firewall
does not open port 80 to the world. On AWS for example, you may need to
configure the "security group" for your server to open port 80.]
...
bin=Scripts. I trust you to adapt the commands you use locally as necessary.
