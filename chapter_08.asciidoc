    ...
    def setUpClass(cls):  <a class="co" id="pt_co_testing_deployment_using_a_staging_site_CO1-1" href="#pt_callout_testing_deployment_using_a_staging_site_CO1-1"><img src="callouts/1.png" alt="1"/></a>
        for arg in sys.argv:  <a class="co" id="pt_co_testing_deployment_using_a_staging_site_CO1-2" href="#pt_callout_testing_deployment_using_a_staging_site_CO1-2"><img src="callouts/2.png" alt="2"/></a>
            if 'liveserver' in arg:  <a class="co" id="pt_co_testing_deployment_using_a_staging_site_CO1-3" href="#pt_callout_testing_deployment_using_a_staging_site_CO1-2"><img src="callouts/2.png" alt="2"/></a>
                ...
                return  <a class="co" id="co_testing_deployment_using_a_staging_site_CO1-5" href="#pt_callout_testing_deployment_using_a_staging_site_CO1-3"><img src="callouts/3.png" alt="3"/></a>
