...
forlorn cry&8212;"'but it works on my machine!'".
...
The solution is a "virtualenv"&8212;a neat way of having different versions of
...
* When using Git-Bash, do not try and run %%activate.bat%%&8212;it is written for
