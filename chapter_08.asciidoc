...
[subs="specialcharacters,macros"]
----
(virtualenv)$ pass:[<strong>pip install 'django<1.9'</strong>]
[...]
Successfully installed django
Cleaning up...
(virtualenv)$ pass:[<strong>python3 manage.py test lists</strong>]
[...]
OK
$ pass:[<strong>ls ../virtualenv/lib/python3.4/site-packages/</strong>]
