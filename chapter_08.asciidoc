...
((("virtualenvs", id="ix_"ix_virtualenv", range="startofrange")))The solution is a "virtualenv"—a neat way of having different versions of
...
Automation is the answer, and it's the topic of the next chapter.(((range="endofrange", startref="id="ix_deptest")))
