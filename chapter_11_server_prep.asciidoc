...
$ *ping 184.123.456.789*  # or whatever your IP is
...
debug1: Reading configuration data /Users/harry.percival/.ssh/config
debug1: Reading configuration data /Users/harry.percival/.colima/ssh_config
...
debug1: Will attempt key: /Users/harry.percival/.ssh/id_ed25519 ED25519 SHA256:gZLxb9zCuGVT1Dm8vB4RRnPMThe27dRzxCSYeiSzn0E agent
debug1: Will attempt key: /Users/harry.percival/.ssh/id_rsa
debug1: Will attempt key: /Users/harry.percival/.ssh/id_ecdsa
debug1: Will attempt key: /Users/harry.percival/.ssh/id_ecdsa_sk
debug1: Will attempt key: /Users/harry.percival/.ssh/id_ed25519_sk
debug1: Will attempt key: /Users/harry.percival/.ssh/id_xmss
debug1: Will attempt key: /Users/harry.percival/.ssh/id_dsa
debug1: Offering public key: /Users/harry.percival/.ssh/id_ed25519 [...]
debug1: Server accepts key: /Users/harry.percival/.ssh/id_ed25519 [...]
...
[role="small-code"]
----
*ansible-playbook --user=elspeth -i staging.ottg.co.uk, infra/deploy-playbook.yaml.yaml -vv*
 ^executable
                  ^our nonroot user
                                 ^  ^ the -i flag specifies what server to run against
    note the trailing comma after the server hostname,^
                                                        ^ path to our playbook
                                          and the -v or -vv flags set verbosity        ^
----
// Ansible is designed to be run against 
...
ansible-playbook [core 2.17.5]
  config file = None
  configured module search path = ['/Users/harry.percival/.ansible/plugins/modules', '/usr/share/ansible/plugins/modules']
  ansible python module location = /Users/harry.percival/workspace/Book-TDD-Web-Dev-Python/.venv/lib/python3.13/site-packages/ansible
  ansible collection location = /Users/harry.percival/.ansible/collections:/usr/share/ansible/collections
  executable location = /Users/harry.percival/workspace/Book-TDD-Web-Dev-Python/.venv/bin/ansible-playbook
  python version = 3.13.0 (main, Oct 11 2024, 22:59:05) [Clang 15.0.0 (clang-1500.3.9.4)] (/Users/harry.percival/workspace/Book-TDD-Web-Dev-Python/.venv/bin/python)
  jinja version = 3.1.4
  libyaml = True
...
task path: /Users/harry.percival/workspace/Book-TDD-Web-Dev-Python/source/chapter_11_server_prep/superlists/infra/deploy-playbook.yaml:1
...
task path: /Users/harry.percival/workspace/Book-TDD-Web-Dev-Python/source/chapter_11_server_prep/superlists/infra/deploy-playbook.yaml:3
