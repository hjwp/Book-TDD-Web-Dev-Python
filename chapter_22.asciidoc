...
------------------------------------
((("test-driven design (TDD)", "advanced considerations in", id="ix_tddadvanced", range="startofrange")))
...
******************************************************************************
((("isolated tests", "vs. integrated tests", sortas="integratedtests")))((("integrated tests", "vs. isolated tests", sortas="isolatedtests)))((("pure unit tests", see="isolated tests")))((("integration tests")))((("system tests")))((("acceptance tests")))((("functional testing (FT)")))
...
(((range="endofrange", startref="ix_tddadvanced")))((("test-driven design (TDD)", "further reading on")))
