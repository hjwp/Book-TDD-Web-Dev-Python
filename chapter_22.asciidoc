...
******************************************************************************
((("isolated tests", "vs. integrated tests", sortas="integratedtests")))((("integrated tests", "vs. isolated tests", sortas="isolatedtests)))((("pure unit tests", see="isolated tests")))((("integration tests")))
