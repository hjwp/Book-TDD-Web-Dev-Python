...
NOTE: ((("JavaScript", "additional resources")))I'm going to assume you know the basics of JavaScript syntax. If you
...
((("JavaScript", "functional test")))((("functional tests (FTs)", "JavaScript", id="FTjava16")))Let's add a new functional test to the `ItemValidationTest` class:
...
((("JavaScript", "test running libraries", id="JStestrunner16")))((("nose")))((("Green")))((("pytest")))((("test running libraries")))Choosing your testing tools in the Python and Django world is fairly
...
((("JavaScript", "jQuery and fixtures div", id="JSjquery16")))((("jQuery", id="jquery16")))((("fixtures div", id="fixtures16")))Let's get a bit more comfortable with what our testing framework can do,
...
((("JavaScript", "unit test")))((("unit tests", "JavaScript")))Now that we're acquainted with our JavaScript testing tools, we can switch
...
((("JavaScript", "managing global state")))((("global state")))((("JavaScript testing", "key challenges of")))One of the difficulties with JavaScript in general, and testing in particular,
...
* ((("JavaScript", "test running libraries")))There are many JavaScript test running libraries out there.  QUnit is closely
  tied to jQuery, which is the main reason I chose it.  

* ((("JavaScript", "managing global state")))((("global state")))No matter which testing library you use, you'll always need to find solutions
