...
NOTE: ((("JavaScrip testing", "additional resources")))I'm going to assume you know the basics of JavaScript syntax. If you
...
((("JavaScrip testing", "functional test")))((("functional tests (FTs)", "JavaScript", id="FTjava16")))Let's add a new functional test to the `ItemValidationTest` class:
...
((("JavaScrip testing", "test running libraries", id="JStestrunner16")))((("nose")))((("Green")))((("pytest")))((("test running libraries")))Choosing your testing tools in the Python and Django world is fairly
...
((("JavaScrip testing", "jQuery and fixtures div", id="JSjquery16")))((("jQuery", id="jquery16")))((("fixtures div", id="fixtures16")))Let's get a bit more comfortable with what our testing framework can do,
...
((("JavaScrip testing", "unit test")))((("unit tests", "JavaScript")))Now that we're acquainted with our JavaScript testing tools, we can switch
...
((("JavaScrip testing", "managing global state")))((("global state")))((("JavaScript testing", "key challenges of", id="JSTkey16")))((("fixtures div")))One of the difficulties with JavaScript in general, and testing in particular,
...
* ((("JavaScrip testing", "test running libraries")))There are many JavaScript test running libraries out there.  QUnit is closely
  tied to jQuery, which is the main reason I chose it.  

* ((("JavaScrip testing", "managing global state")))((("global state")))No matter which testing library you use, you'll always need to find solutions
