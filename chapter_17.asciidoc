...
//TODO: test commands that have return code //did you do this?
[role="skipme"]
[subs="specialcharacters,macros"]
----
...
//TODO: test this somehow //did you do this?
[role="skipme"]
[subs="specialcharacters,macros"]
----
$ pass:quotes[*python3 manage.py create_session a@b.com*]
...
Test important log messages::
    ...
    `patch.object` on the logger for the module you're testing is one convenient
    way of unit testing it.
