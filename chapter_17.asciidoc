...
test_logged_in_users_lists_are_saved_as_my_lists
    self.assert_logged_in(email)
  File "/workspace/superlists/functional_tests/base.py", line 42, in assert_logged_in
    self.browser.find_element_by_link_text('Log out')
[...]
...
We can't log in--either with the real email system or with our pre-authenticated
