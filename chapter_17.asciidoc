...
((("functional tests", "vs. unit tests")))((("unit tests", "vs. functional tests")))This is about separation of concerns.  Functional tests aren't like unit tests,
...
tunnelled port.
(((range="endofrange", startref="ix_stagingtestdb")))((("Functional testing (FT)", "safeguards with")))
...
(((range="endofrange", startref="ix_loggingconfig")))((("functional testing (FT)", "de-duplication")))((("test fixtures")))((("JSON fixtures")))((("Django", "management commands")))((("logging")))((("log messages")))
