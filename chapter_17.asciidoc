...
give the users what they wanted -- the next chapter describes how to give them
the ability to save their lists.
...
This is similar dangerous territory to running tests against the production
database, if you remember my little story about accidentally sending thousands
