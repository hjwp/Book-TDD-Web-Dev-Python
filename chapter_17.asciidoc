...
* add EMAIL_PASSWORD to gunicorn systemd service config
...
correctly, but we can't check the email in the mail.outbox...
...
TODO: finish rewriting this chapter/section

* implement testing of email in FT
