...
== Test Fixtures, Logging, and pass:[<span class="keep-together">Server-Side Debugging</span>]
...
NOTE: If you see an error saying the `auth_user` table is missing, you may need to
run `manage.py migrate`.  In case that doesn't work, delete the `db.sqlite3` file and
...
++++
<pre data-type="programlisting" data-code-language="python" class="sourcecode">from .server_tools import reset_database  <a class="co" id="pt_co_test_fixtures__logging__and___server_side_debugging___CO2-1" href="#pt_callout_test_fixtures__logging__and___server_side_debugging___CO2-2"><img src="callouts/2.png" alt="2"/></a>
...
class FunctionalTest(StaticLiveServerTestCase):
    ...
    def setUpClass(cls):
        for arg in sys.argv:
            if 'liveserver' in arg:
                cls.server_host = arg.split('=')[1] <a class="co" id="pt_co_test_fixtures__logging__and___server_side_debugging___CO2-2" href="#pt_callout_test_fixtures__logging__and___server_side_debugging___CO2-1"><img src="callouts/1.png" alt="1"/></a>
                cls.server_url = 'http://' + cls.server_host
                cls.against_staging = True <a class="co" id="pt_co_test_fixtures__logging__and___server_side_debugging___CO2-3" href="#pt_callout_test_fixtures__logging__and___server_side_debugging___CO2-1"><img src="callouts/1.png" alt="1"/></a>
                return
        super().setUpClass()
    ...
    def setUp(self):
        if self.against_staging:
            reset_database(self.server_host) <a class="co" id="pt_co_test_fixtures__logging__and___server_side_debugging___CO2-4" href="#pt_callout_test_fixtures__logging__and___server_side_debugging___CO2-2"><img src="callouts/2.png" alt="2"/></a>
        self.browser = webdriver.Firefox()
        self.browser.implicitly_wait(3)</pre>
<dl class="calloutlist">
<dt><a class="co" id="pt_callout_test_fixtures__logging__and___server_side_debugging___CO2-1" href="#pt_co_test_fixtures__logging__and___server_side_debugging___CO2-2"><img src="callouts/1.png" alt="1"/></a></dt>
<dd><p>Instead of just storing <code>cls.server_url</code>, we also store the <code>server_host</code>
and <code>against_staging</code> attributes if we detect the <code>liveserver</code> command-line
argument.</p></dd>
<dt><a class="co" id="pt_callout_test_fixtures__logging__and___server_side_debugging___CO2-2" href="#pt_co_test_fixtures__logging__and___server_side_debugging___CO2-1"><img src="callouts/2.png" alt="2"/></a></dt>
<dd><p>We also need a way of resetting the server database in between each test.
    I&#8217;ll explain the logic of the session-creation code, which should also
    explain how this works.
<a data-type="indexterm" data-startref="ix_Djangomancommond"/></p></dd>
</dl>
++++
...
++++
<pre data-type="programlisting" data-code-language="python" class="sourcecode">from os import path
import subprocess
...
def create_session_on_server(host, email):
    return subprocess.check_output(
        [
            'fab',
            'create_session_on_server:email={}'.format(email), <a class="co" id="pt_co_test_fixtures__logging__and___server_side_debugging___CO3-1" href="#pt_callout_test_fixtures__logging__and___server_side_debugging___CO3-1"><img src="callouts/1.png" alt="1"/></a><a class="co" id="pt_co_test_fixtures__logging__and___server_side_debugging___CO3-2" href="#pt_callout_test_fixtures__logging__and___server_side_debugging___CO3-2"><img src="callouts/2.png" alt="2"/></a>
            '--host={}'.format(host),
            '--hide=everything,status', <a class="co" id="pt_co_test_fixtures__logging__and___server_side_debugging___CO3-3" href="#pt_callout_test_fixtures__logging__and___server_side_debugging___CO3-3"><img src="callouts/3.png" alt="3"/></a>
        ],
        cwd=THIS_FOLDER
    ).decode().strip() <a class="co" id="pt_co_test_fixtures__logging__and___server_side_debugging___CO3-4" href="#pt_callout_test_fixtures__logging__and___server_side_debugging___CO3-3"><img src="callouts/3.png" alt="3"/></a>
...
<code>fab</code> <span class="keep-together">command.</span></p>
<dl class="calloutlist">

<dt><a class="co" id="pt_callout_test_fixtures__logging__and___server_side_debugging___CO3-1" href="#pt_co_test_fixtures__logging__and___server_side_debugging___CO3-1"><img src="callouts/1.png" alt="1"/></a></dt>
<dd><p>As you can see, the command-line syntax for arguments to <code>fab</code> functions is
quite simple, a colon and then a variable=argument syntax.</p></dd>

<dt><a class="co" id="pt_callout_test_fixtures__logging__and___server_side_debugging___CO3-2" href="#pt_co_test_fixtures__logging__and___server_side_debugging___CO3-2"><img src="callouts/2.png" alt="2"/></a></dt>
<dd><p>Incidentally, this is also the first time I&#8217;ve shown the "new-style" string
...
<dt><a class="co" id="pt_callout_test_fixtures__logging__and___server_side_debugging___CO3-3" href="#pt_co_test_fixtures__logging__and___server_side_debugging___CO3-3"><img src="callouts/3.png" alt="3"/></a></dt>
<dd><p>Because of all the hopping around via Fabric and subprocesses, we&#8217;re forced
to be quite careful about extracting the session key as a string from the
output of the command as it gets run on the server.</p></dd>
</dl>
++++
