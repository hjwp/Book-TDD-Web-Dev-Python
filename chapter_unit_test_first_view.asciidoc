...
(lists.tests.HomePageTest.test_root_url_resolves_to_home_page_view)
----------------------------------------------------------------------
Traceback (most recent call last):
  File "...goat-book/lists/tests.py", line 8, in
...
django.urls.exceptions.Resolver404: {'tried': [[<URLResolver <URLPattern list>
...
======================================================================
ERROR: test_root_url_resolves_to_home_page_view
(lists.tests.HomePageTest.test_root_url_resolves_to_home_page_view)  <2>
----------------------------------------------------------------------
Traceback (most recent call last):
  File "...goat-book/lists/tests.py", line 8, in
test_root_url_resolves_to_home_page_view
  ...
  File ".../django/urls/resolvers.py", line 702, in resolve
    raise Resolver404({"tried": tried, "path": new_path})
django.urls.exceptions.Resolver404: {'tried': [[<URLResolver <URLPattern list>  <1>
(admin:admin) 'admin/'>]], 'path': ''}  <1>
...
<4> Now we can make some assertions:
    we want it to start with an `<html>` tag which gets closed at the end.

<5> And we want a `<title>` tag somewhere in the middle,
...
----
  File "...goat-book/lists/tests.py", line 9, in test_home_page_returns_correct_html
...
=== TODO the functional tests catch the missing url wiring.
...
(__main__.NewVisitorTest.test_can_start_a_list_and_retrieve_it_later)
 ---------------------------------------------------------------------
Traceback (most recent call last):
  File "...goat-book/functional_tests.py", line 19, in
