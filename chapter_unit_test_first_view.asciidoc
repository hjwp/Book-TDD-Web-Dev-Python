...
https://docs.djangoproject.com/en/4.2/faq/general/[in the Django FAQs].

// DAVID: we could include #django-appears-to-be-a-mvc-framework-but-you-call-the-controller-the-view-and-the-view-the-template-how-come-you-don-t-use-the-standard-names
// in the link above for a better web experience but I'm not sure if this has an adverse impact on the print version.
// Please advise!
...
* Can we tell Django to use this view function
  when we make a request for URL for the root of the site (``/'')?
