...
We can't be adding to http://grokcode.com/746/dear-python-why-are-you-so-ugly/[Python's reputation for being
ugly],
...
_settings.py_ as `STATIC_ROOT`. In the next chapter we'll be doing some
