...
image::images/bootsrap_css_404_devtools.png["Browser devtools showing a 404 for css/bootstrap.min.css, but also at the bottom of the screenshot, the terminal window showing the same URL returing a 404 in the runserver session."]>
...
image::images/tdd3_0803.png["The home page with a big grey box surrounding the title and input"]
