...
Our first attempt at a test suite for this view was highly 'integrated'.  It
...
Decoupling our application from ORM code::
    ((("ORM code, decoupling from", "benefits and drawbacks of")))When striving to write isolated tests, one of the consequences is that we
