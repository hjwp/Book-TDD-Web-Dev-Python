...
((("isolation, ensuring", "vs. integrated tests", secondary-sortas="integrated tests", id="IEinteg23")))Django's testing tools make it very easy to quickly put together integrated
...
you a feel for what the trade-offs are.((("", startref="IEinteg23")))
