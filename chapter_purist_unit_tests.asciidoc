...
((("functional tests (FTs)", "ensuring isolation", id="FTisolat23")))In
...
((("isolation, ensuring", "benefits and drawbacks of")))Ensuring
...
((("isolation, ensuring", "failed test example")))Let
's revisit the point we were at halfway through the last chapter, when we
...
((("", startref="IEmock23")))((("", startref="Misolate23")))But
, boy, that's getting to be an ugly test!
...
((("Object-Relational Mapper (ORM)")))Again
, these tests are trying to tell us something:  the Django ORM
...
((("isolation, ensuring", "layer interactions as contracts", id="IEinteract23")))Ultimately
, even if we had been writing nothing but isolated unit tests, our
...
((("isolation, ensuring", "vs. integrated tests", secondary-sortas="integrated tests", id="IEinteg23")))((("integrated tests", "vs. isolated", secondary-sortas="isolated", id="IEisol23")))Django
's testing tools make it very easy to quickly put together integrated
