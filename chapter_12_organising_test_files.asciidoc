...
NOTE: Keeping helper methods in a base `FunctionalTest` class
    ...
    Later in the book (in <<chapter_24_page_pattern>>) we'll use the "Page pattern",
// CSANAD: is this reference to the chapter "The Token Social Bit, the Page
//         Pattern, and an Exercise for the Reader" as chapter_24_page_pattern
...
See also <<chapter_24_page_pattern>> and <<appendix_bdd>> for more on structuring
your FT code.
*******************************************************************************
