...
See also xref:chapter_page_pattern.asciidoc[The Token Social Bit, the Page Pattern, and an Exercise for the Reader] and xref:appendix_bdd.asciidoc[Appendix A: Behaviour-Driven Development (BDD)]) for more on structuring
your FT code.
*******************************************************************************
